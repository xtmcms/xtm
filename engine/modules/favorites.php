...
if (isset ($_SESSION['xtm_sort_favorites'])) $news_sort_by = $_SESSION['xtm_sort_favorites'];
if (isset ($_SESSION['xtm_direction_favorites'])) $news_direction_by = $_SESSION['xtm_direction_favorites'];
