    ...
    default :
        ...
        if ($do == "cat" and $category != '' and $subaction == '') {
            ...
            if (isset ($view_template) and $view_template == "rss") {
                ...
                if (isset ($_SESSION['xtm_sort_cat'])) $news_sort_by = $_SESSION['xtm_sort_cat'];
                if (isset ($_SESSION['xtm_direction_cat'])) $news_direction_by = $_SESSION['xtm_direction_cat'];
            ...
            if (isset ($_SESSION['xtm_sort_lastnews'])) $news_sort_by = $_SESSION['xtm_sort_lastnews'];
            else $news_sort_by = "date";
            if (isset ($_SESSION['xtm_direction_lastnews'])) $news_direction_by = $_SESSION['xtm_direction_lastnews'];
            ...
            if (isset ($_SESSION['xtm_sort_tags'])) $news_sort_by = $_SESSION['xtm_sort_tags'];
            if (isset ($_SESSION['xtm_direction_tags'])) $news_direction_by = $_SESSION['xtm_direction_tags'];
            ...
            if (isset ($_SESSION['xtm_sort_xfsearch'])) $news_sort_by = $_SESSION['xtm_sort_xfsearch'];
            if (isset ($_SESSION['xtm_direction_xfsearch'])) $news_direction_by = $_SESSION['xtm_direction_xfsearch'];
            ...
            if ($member_id['name'] == $user or $user_group[$member_id['user_group']]['allow_all_edit']) {
                if (isset ($_SESSION['xtm_sort_userinfo'])) $news_sort_by = $_SESSION['xtm_sort_userinfo'];
                if (isset ($_SESSION['xtm_direction_userinfo'])) $news_direction_by = $_SESSION['xtm_direction_userinfo'];
            ...
            if (isset ($view_template) and $view_template == "rss") {
                ...
                if (isset ($_SESSION['xtm_sort_allnews'])) $news_sort_by = $_SESSION['xtm_sort_allnews'];
                if (isset ($_SESSION['xtm_direction_allnews'])) $news_direction_by = $_SESSION['xtm_direction_allnews'];
            ...
            if (isset ($_SESSION['xtm_sort_newposts'])) $news_sort_by = $_SESSION['xtm_sort_newposts'];
            if (isset ($_SESSION['xtm_direction_newposts'])) $news_direction_by = $_SESSION['xtm_direction_newposts'];
            ...
            if (isset ($_SESSION['xtm_sort_catalog'])) $news_sort_by = $_SESSION['xtm_sort_catalog'];
            if (isset ($_SESSION['xtm_direction_catalog'])) $news_direction_by = $_SESSION['xtm_direction_catalog'];
            ...
            if ($year == '' AND $month == '' AND $day == '' AND !$newsid) {
                ...
                if (isset ($view_template) and $view_template == "rss") {
                    ...
                    if (isset ($_SESSION['xtm_sort_main'])) $news_sort_by = $_SESSION['xtm_sort_main'];
                    if (isset ($_SESSION['xtm_direction_main'])) $news_direction_by = $_SESSION['xtm_direction_main'];
                    $sql_select = "SELECT p.id, p.autor, p.date, p.short_story, CHAR_LENGTH(p.full_story) as full_story, p.xfields, p.title, p.category, p.alt_name, p.comm_num, p.allow_comm, p.fixed, p.tags, e.news_read, e.allow_rate, e.rating, e.vote_num, e.votes, e.view_edit, e.editdate, e.editor, e.reason FROM " . PREFIX . "_post p LEFT JOIN " . PREFIX . "_post_extras e ON (p.id=e.news_id) WHERE {$stop_list}approve=1 AND allow_main=1" . $where_date . " ORDER BY " . $fixed . $news_sort_by . " " . $news_direction_by . " LIMIT " . $cstart . "," . $config['news_number'];
                    $sql_count = "SELECT COUNT(*) as count FROM " . PREFIX . "_post WHERE {$stop_list}approve=1 AND allow_main=1" . $where_date;
                }
            }
            if ($year != '' and $month == '' and $day == '') {
                ...
                if (isset ($_SESSION['xtm_sort_date'])) $news_sort_by = $_SESSION['xtm_sort_date'];
                if (isset ($_SESSION['xtm_direction_date'])) $news_direction_by = $_SESSION['xtm_direction_date'];
        ...
        if (($subaction == "showfull" or $subaction == "addcomment") and ((!isset ($category) or $category == ""))) {
            ...
            if (isset($view_template) AND $view_template == "rss") {
                if ($catalog) $active = xtm_cache("rss", $catalog, false);
                else $active = xtm_cache("rss", $category_id, false);
            } else {
                ...
                if (isset($_SESSION['xtm_no_cache']) AND $_SESSION['xtm_no_cache']) $config['allow_cache'] = false;
                if ($cstart) $cache_id = ($cstart / $config['news_number']) + 1;
                else $cache_id = "1";
                if ($cache_id < 6 and !isset ($_POST['login'])) $active = xtm_cache("news", $cache_id . $cache_prefix, true);
                else $active = false;
            }
            if ($active) {
...
if ($config['speedbar'] and !isset ($view_template)) {
    ...
    $tpl->set('{speedbar}', '<span id=\'xtm-speedbar\'>' . stripslashes($s_navigation) . '</span>');
