...
(function (a, b) {
    ...
    var c = a.document, d = a.navigator, e = a.location, f = function () {
        ...
        }), A = e.uaMatch(z), A.browser && (e.browser[A.browser] = !0, e.browser.version = A.version), e.browser.webkit && (e.browser.safari = !0), j.test("В ") && (k = /^[\s\xA0]+/, l = /[\s\xA0]+$/), h = e(c), c.addEventListener ? C = function () {
    ...
    f.event = {add:function (a, c, d, e, g) {
        ...
        if (!(a.nodeType === 3 || a.nodeType === 8 || !c || !d || !(h = f._data(a)))) {
            d.handler && (p = d, d = p.handler), d.guid || (d.guid = f.guid++), j = h.events, j || (h.events = j = {}), i = h.hanxtm, i || (h.hanxtm = i = function (a) {
        ...
        if (!!e && !!(m = e.events)) {
            ...
            for (g = 0; g < b.length; g++) {
                ...
                p.length === 0 && k !== p.length && ((!n.teardown || n.teardown.call(a, j) === !1) && f.removeEvent(a, i, e.hanxtm), delete m[i])
            }
            f.isEmptyObject(m) && (o = e.hanxtm, o && (o.elem = null), f.removeData(a, ["events", "hanxtm"], !0))
        }
        ...
        if (!e || e.nodeType !== 3 && e.nodeType !== 8) {
            ...
            if (!e) {
                j = f.cache;
                for (l in j)j[l].events && j[l].events[h] && f.event.trigger(c, d, j[l].hanxtm.elem, !0);
                return
            }
            ...
            for (l = 0; l < r.length; l++) {
                m = r[l][0], c.type = r[l][1], q = (f._data(m, "events") || {})[c.type] && f._data(m, "hanxtm"), q && q.apply(m, d), q = o && m[o], q && f.acceptData(m) && q.apply(m, d);
        ...
        var d = (f._data(this, "events") || {})[c.type] || [], e = d.delegateCount, g = [].slice.call(arguments, 0), h = !c.exclusive && !c.namespace, i = (f.event.special[c.type] || {}).hanxtm, j = [], k, l, m, n, o, p, q, r, s, t, u;
        ...
        for (k = 0; k < j.length && !c.isPropagationStopped(); k++) {
            ...
            for (l = 0; l < p.matches.length && !c.isImmediatePropagationStopped(); l++) {
                r = p.matches[l];
                if (h || !c.namespace && !r.namespace || c.namespace_re && c.namespace_re.test(r.namespace))c.data = r.data, c.hanxtmObj = r, n = (i || r.handler).apply(p.elem, g), n !== b && (c.result = n, n === !1 && (c.preventDefault(), c.stopPropagation()))
            }
        }
        return c.result
    ...
    }}, f.event.hanxtm = f.event.dispatch, f.removeEvent = c.removeEventListener ? function (a, b, c) {
        ...
        f.event.special[a] = f.event.special[b] = {delegateType:b, bindType:b, hanxtm:function (a) {
            var b = this, c = a.relatedTarget, d = a.hanxtmObj, e = d.selector, g, h;
        ...
        if (a && a.preventDefault && a.hanxtmObj) {
            var e = a.hanxtmObj;
        ...
        var n = m.getText = function (a) {
            ...
            return e
        }, o = m.selectors = {order:["ID", "NAME", "TAG"], match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/, CLASS:/\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/, NAME:/\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/, ATTR:/\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(?:(['"])(.*?)\3|(#?(?:[\w\u00c0-\uFFFF\-]|\\.)*)|)|)\s*\]/, TAG:/^((?:[\w\u00c0-\uFFFF\*\-]|\\.)+)/, CHILD:/:(only|nth|last|first)-child(?:\(\s*(even|odd|(?:[+\-]?\d+|(?:[+\-]?\d*)?n\s*(?:[+\-]\s*\d+)?))\s*\))?/, POS:/:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^\-]|$)/, PSEUDO:/:((?:[\w\u00c0-\uFFFF\-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/}, leftMatch:{}, attrMap:{"class":"className", "for":"htmlFor"}, attrHanxtm:{href:function (a) {
            ...
            var c = b[1], d = m.attr ? m.attr(a, c) : o.attrHanxtm[c] ? o.attrHanxtm[c](a) : a[c] != null ? a[c] : a.getAttribute(c), e = d + "", f = b[2], g = b[4];
        ...
        c.documentElement.compareDocumentPosition ? u = function (a, b) {
            ...
            a.appendChild(c.createComment("")), a.getElementsByTagName("*").length > 0 && (o.find.TAG = function (a, b) {
                ...
                return c
            }), a.innerHTML = "<a href='#'></a>", a.firstChild && typeof a.firstChild.getAttribute != "undefined" && a.firstChild.getAttribute("href") !== "#" && (o.attrHanxtm.href = function (a) {
    ...
    bj.optgroup = bj.option, bj.tbody = bj.tfoot = bj.colgroup = bj.caption = bj.thead, bj.th = bj.td, f.support.htmlSerialize || (bj._default = [1, "div<div>", "</div>"]), f.fn.extend({text:function (a) {
        ...
        for (var h = 0, i; (i = a[h]) != null; h++) {
            ...
            if (c) {
                b = d[c];
                if (b && b.events) {
                    for (var j in b.events)e[j] ? f.event.remove(i, j) : f.removeEvent(i, j, b.hanxtm);
                    b.hanxtm && (b.hanxtm.elem = null)
                }
