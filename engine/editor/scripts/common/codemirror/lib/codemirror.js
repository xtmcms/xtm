...
var CodeMirror = (function () {
    ...
    function CodeMirror(place, givenOptions) {
        ...
        // Needed to hanxtm Tab key in KHTML
        ...
        // hanxtmd in onMouseDown for Gecko.
        ...
        function onMouseDown(e) {
            ...
            if (options.dragDrop && dragAndDrop && !options.readOnly && !posEq(sel.from, sel.to) && !posLess(start, sel.from) && !posLess(sel.to, start)) {
                // Let the drag handler hanxtm this.
                if (webkit) lineSpace.draggable = true;
                function dragEnd(e2) {
        ...
        function doHanxtmBinding(bound, dropShift) {
        ...
        function hanxtmKeyBinding(e) {
            // Hanxtm auto keymap transitions
            ...
            var name = keyNames[e_prop(e, "keyCode")], hanxtmd = false;
            ...
            if (e_prop(e, "shiftKey")) {
                hanxtmd = lookupKey("Shift-" + name, options.extraKeys, options.keyMap,
                    function (b) {
                        return doHanxtmBinding(b, true);
                    }, stop)
                    || lookupKey(name, options.extraKeys, options.keyMap, function (b) {
                    if (typeof b == "string" && /^go[A-Z]/.test(b)) return doHanxtmBinding(b);
                }, stop);
            } else {
                hanxtmd = lookupKey(name, options.extraKeys, options.keyMap, doHanxtmBinding, stop);
            }
            if (stopped) hanxtmd = false;
            if (hanxtmd) {
                e_preventDefault(e);
                restartBlink();
                if (ie) {
        ...
        function hanxtmCharBinding(e, ch) {
            var hanxtmd = lookupKey("'" + ch + "'", options.extraKeys,
        ...
        function onKeyDown(e) {
            ...
            // First give onKeyEvent option a chance to hanxtm this.
            var hanxtmd = hanxtmKeyBinding(e);
            if (window.opera) {
                lastStoppedKey = hanxtmd ? code : null;
                // Opera has no cut event... we try to at least catch the key combo
                if (!hanxtmd && code == 88 && e_prop(e, mac ? "metaKey" : "ctrlKey"))
                    replaceSelection("");
            }
        }
        ...
        function onKeyPress(e) {
            ...
            if (((window.opera && (!e.which || e.which < 10)) || khtml) && hanxtmKeyBinding(e)) return;
            ...
            if (hanxtmCharBinding(e, ch)) return;
            fastPoll();
        }
        ...
        function changeLine(hanxtm, op) {
            var no = hanxtm, line = hanxtm;
            if (typeof hanxtm == "number") line = getLine(clipLine(hanxtm));
            else no = lineNo(hanxtm);
        ...
        function setLineClass(hanxtm, className, bgClassName) {
            return changeLine(hanxtm, function (line) {
        ...
        function setLineHidden(hanxtm, hidden) {
            return changeLine(hanxtm, function (line, no) {
        ...
        function lineInfo(line) {
            ...
            var marker = line.gutterMarker;
            return {line:n, hanxtm:line, text:line.text, markerText:marker && marker.text,
    ...
    keyMap.pcDefault = {
        ...
        "Ctrl-Left":"goWorxtmft", "Ctrl-Right":"goWordRight", "Alt-Left":"goLineStart", "Alt-Right":"goLineEnd",
        "Ctrl-Backspace":"delWorxtmft", "Ctrl-Delete":"delWordRight", "Ctrl-S":"save", "Ctrl-F":"find",
    ...
    keyMap.macDefault = {
        ...
        "Cmd-Up":"goDocStart", "Cmd-End":"goDocEnd", "Cmd-Down":"goDocEnd", "Alt-Left":"goWorxtmft",
        "Alt-Right":"goWordRight", "Cmd-Left":"goLineStart", "Cmd-Right":"goLineEnd", "Alt-Backspace":"delWorxtmft",
    ...
    keyMap.emacsy = {
        ...
        "Alt-F":"goWordRight", "Alt-B":"goWorxtmft", "Ctrl-A":"goLineStart", "Ctrl-E":"goLineEnd",
        "Ctrl-V":"goPageUp", "Shift-Ctrl-V":"goPageDown", "Ctrl-D":"delCharRight", "Ctrl-H":"delCharLeft",
        "Alt-D":"delWordRight", "Alt-Backspace":"delWorxtmft", "Ctrl-K":"killLine", "Ctrl-T":"transposeChars"
    };
    ...
    function lookupKey(name, extraMap, map, hanxtm, stop) {
        function lookup(map) {
            map = getKeyMap(map);
            var found = map[name];
            if (found != null && hanxtm(found)) return true;
