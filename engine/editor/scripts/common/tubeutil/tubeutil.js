jQTubeUtil = function (h) {
    function i(a, b, c) {
        var d = {"max-results":b.max || l, "start-index":b.start || u};
    ...
    function j(a, b) {
        switch (typeof a) {
            case "function":
                return{callback:a, time:undefined};
            case "object":
                var c = {max:a.max, start:a["start-index"]};
                if (b)c.time = a.time;
                return c;
            default:
                return{}
    ...
    function n(a, b) {
        var c = {};
        h.ajax({type:"GET", dataType:"json", url:a, success:function (d) {
            if (typeof d != "undefined") {
                var g = [];
                if (d.feed) {
                    var e =
                        d.feed, p = d.feed.entry;
    ...
    var k = {q:"", orderby:OrderBy[2], time:Times[3], "max-results":l}, r = {key:"", format:5, alt:"json", callback:"?"}, t = {hl:"en", ds:"yt", client:"youtube", hjson:"t", cp:1};
    f.init = function (a) {
    ...
    f.suggest = function (a, b) {
        a = {q:encodeURIComponent(a)};
        var c = m(SuggestURL, h.extend({}, t, a));
        h.ajax({type:"GET", dataType:"json", url:c, success:function (d) {
            var g = [], e = {};
    ...
    f.search = function (a, b) {
        if (typeof a == "string")a = {q:encodeURIComponent(a)};
