...
if (!$row['user_id']) {
    echo "<div id='xtmprofilepopup' title='{$lang['all_err_1']}' style='display:none'><br />{$lang['news_err_26']}</div>";
} else {
    ...
    echo "<div id='xtmprofilepopup' title='{$lang['p_user']} {$row['name']}' style='display:none'>{$tpl->result['content']}</div>";
}
?>