...
if ($config['http_home_url'] == "") {
    $config['http_home_url'] = explode("lib/ajax/favorites.php", $_SERVER['PHP_SELF']);
...
if ($_REQUEST['action'] == "plus") {
    ...
    $buffer = "<img src=\"" . $config['http_home_url'] . "templates/{$config['skin']}/xtmimages/minus_fav.gif\" onclick=\"doFavorites('" . $id . "', 'minus'); return false;\" title=\"" . $lang['news_minfav'] . "\" style=\"vertical-align: middle;border: none;\" />";
    ...
    $buffer = "<img src=\"" . $config['http_home_url'] . "templates/{$config['skin']}/xtmimages/plus_fav.gif\" onclick=\"doFavorites('" . $id . "', 'plus'); return false;\" title=\"" . $lang['news_addfav'] . "\" style=\"vertical-align: middle;border: none;\" />";
} else die("error");
$db->close();
