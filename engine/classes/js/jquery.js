...
(function (a, b) {
    ...
    p.event = {add:function (a, c, d, e, f) {
        ...
        d.handler && (o = d, d = o.handler, f = o.selector), d.guid || (d.guid = p.guid++), i = g.events, i || (g.events = i = {}), h = g.hanxtm, h || (g.hanxtm = h = function (a) {
        ...
        for (f = 0; f < b.length; f++) {
            ...
            o.length === 0 && k !== o.length && ((!n.teardown || n.teardown.call(a, j, r.hanxtm) === !1) && p.removeEvent(a, h, r.hanxtm), delete m[h])
        }
        p.isEmptyObject(m) && (delete r.hanxtm, p.removeData(a, "events", !0))
        ...
        if (!f || f.nodeType !== 3 && f.nodeType !== 8) {
            ...
            if (!f) {
                h = p.cache;
                for (j in h)h[j].events && h[j].events[s] && p.event.trigger(c, d, h[j].hanxtm.elem, !0);
                return
            }
            ...
            for (j = 0; j < q.length && !c.isPropagationStopped(); j++)k = q[j][0], c.type = q[j][1], o = (p._data(k, "events") || {})[c.type] && p._data(k, "hanxtm"), o && o.apply(k, d), o = m && k[m], o && p.acceptData(k) && o.apply(k, d) === !1 && c.preventDefault();
        ...
        for (d = 0; d < t.length && !c.isPropagationStopped(); d++) {
            ...
            for (e = 0; e < i.matches.length && !c.isImmediatePropagationStopped(); e++) {
                k = i.matches[e];
                if (r || !c.namespace && !k.namespace || c.namespace_re && c.namespace_re.test(k.namespace))c.data = k.data, c.hanxtmObj = k, g = ((p.event.special[k.origType] || {}).hanxtm || k.handler).apply(i.elem, q), g !== b && (c.result = g, g === !1 && (c.preventDefault(), c.stopPropagation()))
            }
        }
    ...
    }}, p.event.hanxtm = p.event.dispatch, p.removeEvent = e.removeEventListener ? function (a, b, c) {
        ...
        p.event.special[a] = {delegateType:b, bindType:b, hanxtm:function (a) {
            var c, d = this, e = a.relatedTarget, f = a.hanxtmObj, g = f.selector;
        ...
        var b = a.target;
        if (this !== b || a.isSimulated || a.isTrigger || b.type !== "radio" && b.type !== "checkbox")return a.hanxtmObj.handler.apply(this, arguments)
    }, teardown:function () {
        ...
        var e, f;
        if (a && a.preventDefault && a.hanxtmObj)return e = a.hanxtmObj, p(a.delegateTarget).off(e.namespace ? e.origType + "." + e.namespace : e.origType, e.selector, e.handler), this;
        if (typeof a == "object") {
        ...
        $.matches = function (a, b) {
            ...
            var c, d = h(a);
            return d || (b = b.toLowerCase()), f.attrHanxtm[b] ? f.attrHanxtm[b](a) : W || d ? a.getAttribute(b) : (c = a.getAttributeNode(b), c ? typeof a[b] == "boolean" ? a[b] ? b : null : c.specified ? c.value : null : null)
        }, f = $.selectors = {cacheLength:50, createPseudo:v, match:S, order:new RegExp("ID|TAG" + (Y ? "|NAME" : "") + (X ? "|CLASS" : "")), attrHanxtm:V ? {} : {href:function (a) {
    ...
    bz.optgroup = bz.option, bz.tbody = bz.tfoot = bz.colgroup = bz.caption = bz.thead, bz.th = bz.td, p.support.htmlSerialize || (bz._default = [1, "X<div>", "</div>"]), p.fn.extend({text:function (a) {
        ...
        for (; (e = a[g]) != null; g++)if (b || p.acceptData(e)) {
            d = e[h], c = d && i[d];
            if (c) {
                if (c.events)for (f in c.events)k[f] ? p.event.remove(e, f) : p.removeEvent(e, f, c.hanxtm);
