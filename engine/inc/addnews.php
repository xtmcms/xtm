...
HTML;
    ...
    if ($member_id['user_group'] < 3) $disable_index = "<input type=\"checkbox\" name=\"disable_index\" value=\"1\">&nbsp;{$lang['add_disable_index']}";
    else $disable_index = "&nbsp;";
...
jQuery(document).ready(function($){
	initTabs('xtm_tabView1',Array('{$lang['tabs_news']}','{$lang['tabs_vote']}','{$lang['tabs_extra']}','{$lang['tabs_perm']}'),0, '100%');
});
	</script>
HTML;
    echofooter();
