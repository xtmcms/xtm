...
if ($action == "del") {
    if ($_REQUEST['user_hash'] == "" or $_REQUEST['user_hash'] != $xtm_login_hash) {
    ...
    if ($action == "add") {
        ...
        if ($user_group[$id]['allow_offline']) $allow_offline_yes = "checked";
        else $allow_offline_no = "checked";
        if ($user_group[$id]['allow_admin']) $allow_admin_yes = "checked";
        else $allow_admin_no = "checked";
        if ($user_group[$id]['allow_adds']) $allow_adds_yes = "checked";
        else $allow_adds_no = "checked";
        if ($user_group[$id]['moderation']) $moderation_yes = "checked";
        else $moderation_no = "checked";
        if ($user_group[$id]['allow_edit']) $allow_edit_yes = "checked";
        else $allow_edit_no = "checked";
        if ($user_group[$id]['allow_all_edit']) $allow_all_edit_yes = "checked";
        else $allow_all_edit_no = "checked";
        if ($user_group[$id]['allow_addc']) $allow_addc_yes = "checked";
        else $allow_addc_no = "checked";
        if ($user_group[$id]['allow_editc']) $allow_editc_yes = "checked";
        else $allow_editc_no = "checked";
        if ($user_group[$id]['allow_delc']) $allow_delc_yes = "checked";
        else $allow_delc_no = "checked";
        if ($user_group[$id]['edit_allc']) $edit_allc_yes = "checked";
        else $edit_allc_no = "checked";
        if ($user_group[$id]['del_allc']) $del_allc_yes = "checked";
        else $del_allc_no = "checked";
        if ($user_group[$id]['allow_hide']) $allow_hide_yes = "checked";
        else $allow_hide_no = "checked";
        if ($user_group[$id]['allow_pm']) $allow_pm_yes = "checked";
        else $allow_pm_no = "checked";
        if ($user_group[$id]['allow_vote']) $allow_vote_yes = "checked";
        else $allow_vote_no = "checked";
        if ($user_group[$id]['allow_files']) $allow_files_yes = "checked";
        else $allow_files_no = "checked";
        if ($user_group[$id]['allow_feed']) $allow_feed_yes = "checked";
        else $allow_feed_no = "checked";
        if ($user_group[$id]['allow_search']) $allow_search_yes = "checked";
        else $allow_search_no = "checked";
        if ($user_group[$id]['allow_rating']) $allow_rating_yes = "checked";
        else $allow_rating_no = "checked";
        if ($user_group[$id]['allow_short']) $allow_short_yes = "checked";
        else $allow_short_no = "checked";
        if ($user_group[$id]['time_limit']) $time_limit_yes = "checked";
        else $time_limit_no = "checked";
        if ($user_group[$id]['allow_fixed']) $allow_fixed_yes = "checked";
        else $allow_fixed_no = "checked";
        if ($user_group[$id]['allow_poll']) $allow_poll_yes = "checked";
        else $allow_poll_no = "checked";
        if ($user_group[$id]['allow_main']) $allow_main_yes = "checked";
        else $allow_main_no = "checked";
        if ($user_group[$id]['captcha']) $allow_captcha_yes = "checked";
        else $allow_captcha_no = "checked";
        if ($user_group[$id]['captcha_pm']) $allow_captcha_pm_yes = "checked";
        else $allow_captcha_pm_no = "checked";
        if ($user_group[$id]['allow_modc']) $allow_modc_yes = "checked";
        else $allow_modc_no = "checked";
        if ($user_group[$id]['allow_image_upload']) $allow_image_upload_yes = "checked";
        else $allow_image_upload_no = "checked";
        if ($user_group[$id]['allow_file_upload']) $allow_file_upload_yes = "checked";
        else $allow_file_upload_no = "checked";
        if ($user_group[$id]['allow_signature']) $allow_signature_yes = "checked";
        else $allow_signature_no = "checked";
        if ($user_group[$id]['allow_url']) $allow_url_yes = "checked";
        else $allow_url_no = "checked";
        if ($user_group[$id]['allow_image']) $allow_image_yes = "checked";
        else $allow_image_no = "checked";
        if ($user_group[$id]['news_sec_code']) $news_sec_code_yes = "checked";
        else $news_sec_code_no = "checked";
        if ($user_group[$id]['admin_addnews']) $admin_addnews_yes = "checked";
        else $admin_addnews_no = "checked";
        if ($user_group[$id]['admin_editnews']) $admin_editnews_yes = "checked";
        else $admin_editnews_no = "checked";
        if ($user_group[$id]['admin_comments']) $admin_comments_yes = "checked";
        else $admin_comments_no = "checked";
        if ($user_group[$id]['admin_categories']) $admin_categories_yes = "checked";
        else $admin_categories_no = "checked";
        if ($user_group[$id]['admin_editusers']) $admin_editusers_yes = "checked";
        else $admin_editusers_no = "checked";
        if ($user_group[$id]['admin_wordfilter']) $admin_wordfilter_yes = "checked";
        else $admin_wordfilter_no = "checked";
        if ($user_group[$id]['admin_xfields']) $admin_xfields_yes = "checked";
        else $admin_xfields_no = "checked";
        if ($user_group[$id]['admin_userfields']) $admin_userfields_yes = "checked";
        else $admin_userfields_no = "checked";
        if ($user_group[$id]['admin_static']) $admin_static_yes = "checked";
        else $admin_static_no = "checked";
        if ($user_group[$id]['admin_editvote']) $admin_editvote_yes = "checked";
        else $admin_editvote_no = "checked";
        if ($user_group[$id]['admin_newsletter']) $admin_newsletter_yes = "checked";
        else $admin_newsletter_no = "checked";
        if ($user_group[$id]['admin_blockip']) $admin_blockip_yes = "checked";
        else $admin_blockip_no = "checked";
        if ($user_group[$id]['admin_banners']) $admin_banners_yes = "checked";
        else $admin_banners_no = "checked";
        if ($user_group[$id]['admin_rss']) $admin_rss_yes = "checked";
        else $admin_rss_no = "checked";
        if ($user_group[$id]['admin_iptools']) $admin_iptools_yes = "checked";
        else $admin_iptools_no = "checked";
        if ($user_group[$id]['admin_rssinform']) $admin_rssinform_yes = "checked";
        else $admin_rssinform_no = "checked";
        if ($user_group[$id]['admin_googlemap']) $admin_googlemap_yes = "checked";
        else $admin_googlemap_no = "checked";
        if ($user_group[$id]['allow_html']) $allow_html_yes = "checked";
        else $allow_html_no = "checked";
        if ($user_group[$id]['allow_subscribe']) $allow_subscribe_yes = "checked";
        else $allow_subscribe_no = "checked";
        if ($user_group[$id]['allow_image_size']) $allow_image_size_yes = "checked";
        else $allow_image_size_no = "checked";
        if ($user_group[$id]['force_leech']) $force_leech_yes = "checked";
        else $force_leech_no = "checked";
        if ($user_group[$id]['admin_tagscloud']) $admin_tagscloud_yes = "checked";
        else $admin_tagscloud_no = "checked";
        if ($user_group[$id]['admin_complaint']) $admin_complaint_yes = "checked";
        else $admin_complaint_no = "checked";
        if ($user_group[$id]['comments_question']) $comments_question_yes = "checked";
        else $comments_question_no = "checked";
        if ($user_group[$id]['news_question']) $news_question_yes = "checked";
        else $news_question_no = "checked";
        if ($user_group[$id]['pm_question']) $pm_question_yes = "checked";
        else $pm_question_no = "checked";
        if ($user_group[$id]['captcha_feedback']) $captcha_feedback_yes = "checked";
        else $captcha_feedback_no = "checked";
        if ($user_group[$id]['feedback_question']) $feedback_question_yes = "checked";
        else $feedback_question_no = "checked";
...
if (m_id > 5) {
menu[1]='<a href="?mod=usergroup&action=del&user_hash={$xtm_login_hash}&id=' + m_id + '" >{$lang['group_sel2']}</a>';
}
else {
