...
if (isset ($xfieldssubactionadd)) if ($xfieldssubactionadd == "add") {
...
if ($xf_inited !== true) {
    function xfieldssave($data)
    {
        ...
        $filehanxtm = fopen(ENGINE_DIR . '/data/xfields.txt', "w+");
        if (!$filehanxtm) msg("error", $lang['xfield_error'], "$lang[xfield_err_1] \"" . ENGINE_DIR . "/data/xfields.txt\", $lang[xfield_err_1]");
        ...
        $filecontents = str_replace("?>", "?&gt;", $filecontents);
        $filecontents = str_replace("$", "&#036;", $filecontents);
        fwrite($filehanxtm, $filecontents);
        fclose($filehanxtm);
    ...
    {
        $index2 = $index1 + $dist;
        if ($index1 < 0 or $index1 > count($array) - 1 or $index2 < 0 or $index2 > count($array) - 1) {
            return false;
        }
        $value1 = $array[$index1];
    ...
    case "configure":
        ...
        switch ($xfieldssubaction) {
            case "delete":
                ...
                msg("options", "info", "$lang[xfield_err_6]<br /><br /><a href=\"$PHP_SELF?mod=xfields&amp;xfieldsaction=configure&amp;xfieldsindex=$xfieldsindex&amp;xfieldssubaction=delete2&user_hash={$xtm_login_hash}\"><input onclick=\"document.location='?mod=xfields&xfieldsaction=configure&xfieldsindex={$xfieldsindex}&xfieldssubaction=delete2&user_hash={$xtm_login_hash}'\" type=\"button\" class=\"btn btn-success\" value=\"{$lang['opt_sys_yes']}\"></a>&nbsp;&nbsp;<a href=\"$PHP_SELF?mod=xfields&amp;xfieldsaction=configure\"><input onclick=\"document.location='?mod=xfields&xfieldsaction=configure'\" type=\"button\" class=\"btn btn-danger\" value=\"{$lang['opt_sys_no']}\"></a>");
                break;
            case "delete2":
                if (!isset($xfieldsindex)) {
                    msg("error", $lang['xfield_error'], $lang['xfield_err_5'], "javascript:history.go(-1)");
            ...
            <form action="<?php echo $_SERVER["PHP_SELF"];
                ...
                <input type="hidden" name="user_hash" value="<?php echo $xtm_login_hash;
                    ?>">
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td style="padding:5px;" bgcolor="#FFFFFF">
                                <table width="100%">
                                    <tr>
                                        <td bgcolor="#EFEFEF" height="29" style="padding-left:10px;">
                                            <div class="navigation"><?php echo $lang['xfield_title'];
                                                ?></div>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table width="100%">
                                    <tr>
                                        <td width="200" style="padding:4px;"><?php echo $lang['xfield_xname'];
                                            ?></td>
                                        <td><input class=edit style="width: 312px;" type="text" name="editedxfield[0]"
                                                   value="<?php echo $editedxfield[0];
                                                       ?>"/>&nbsp;&nbsp;&nbsp;(<?php echo $lang['xf_lat'];
                                            ?>)
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding:4px;"><?php echo $lang['xfield_xdescr'];
                                            ?></td>
                                        <td><input class=edit style="width: 312px;" type="text" name="editedxfield[1]"
                                                   value="<?php echo $editedxfield[1];
                                                       ?>"/></td>
                                    </tr>
                                    <?php
                                    $cat_options = CategoryNewsSelection(explode(',', $editedxfield[2]), 0, false);
                                    if ($editedxfield[2] == "") $cats_value = "selected";
                                    else $cats_value = "";
                                    echo <<<HTML
    <tr>
...
HTML;
                                    ?>
                                    <tr>
                                        <td style="padding:4px;"><?php echo $lang['xfield_xtype'];
                                            ?></td>
                                        <td><select name="editedxfield[3]" id="type"
                                                    onchange="onTypeChange(this.value)"/>
                                            <option value="text"<?php if ($editedxfield[3] != "textarea") echo " selected";
                                            else echo "";
                                                ?>><?php echo $lang['xfield_xstr'];
                                                ?></option>
                                            <option value="textarea"<?php echo ($editedxfield[3] == "textarea") ? " selected" : "";
                                                ?>><?php echo $lang['xfield_xarea'];
                                                ?></option>
                                            <option value="select"<?php echo ($editedxfield[3] == "select") ? " selected" : "";
                                                ?>><?php echo $lang['xfield_xsel'];
                                                ?></option>
                                            </select></td>
                                    </tr>
                                    <tr id="default_text">
                                        <td style="padding:4px;"><?php echo $lang['xfield_xfaul'];
                                            ?></td>
                                        <td><input class=edit style="width: 320px;" type="text"
                                                   name="editedxfield[4_text]"
                                                   value="<?php if ($editedxfield[3] == "text") echo htmlspecialchars($editedxfield[4], ENT_QUOTES, $config['charset']);
                                                   else echo "";
                                                       ?>"/></td>
                                    </tr>
                                    <tr id="default_textarea">
                                        <td style="padding:4px;"><?php echo $lang['xfield_xfaul'];
                                            ?></td>
                                        <td><textarea style="width: 320px; height: 100px;"
                                                      name="editedxfield[4_textarea]"><?php echo ($editedxfield[3] == "textarea") ? $editedxfield[4] : "";
                                            ?></textarea></td>
                                    </tr>
                                    <tr id="select_options">
                                        <td style="padding:4px;"><?php echo $lang['xfield_xfaul'];
                                            ?></td>
                                        <td><textarea style="width: 320px; height: 100px;"
                                                      name="editedxfield[4_select]"><?php echo ($editedxfield[3] == "select") ? $editedxfield[4] : "";
                                            ?></textarea><br><?php echo $lang['xfield_xfsel'];
                                            ?></td>
                                    </tr>
                                    <tr>
                                        <td colspan=2>
                                    ...
                                    <tr>
                                        <td colspan=2>
                                            <div id="optional">
      <span><input type="checkbox" name="editedxfield[5]"<?php echo $checked;
          ?> id="editxfive"/>
    <label for="editxfive"> <?php echo $lang['xfield_xw'];
        ?></label></span></div>
                                            <div id="optional2">
      <span><input type="checkbox" name="editedxfield[6]"<?php echo $checked2;
          ?> id="editxsixt"/>
    <label for="editxsixt"> <?php echo $lang['xfield_xw2'];
        ?><a href="#" class="hintanchor" onMouseover="showhint('<?php echo $lang['xfield_xw3'];
            ?>', this, event, '420px')">[?]</a></label></span></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan=2 style="padding:4px;"><input type="submit" class="btn btn-success"
                                                                                  value="&nbsp;&nbsp;<?php echo $lang['user_save'];
                                                                                      ?>&nbsp;&nbsp;"></td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <tr>
                                ...
                                <td style="padding:5px;" bgcolor="#FFFFFF">
                                    <table width="100%">
                                        <tr>
                                            <td bgcolor="#EFEFEF" height="29" style="padding-left:10px;">
                                                <div class="navigation"><?php echo $lang['xfield_xlist'];
                                                    ?></div>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td style="padding:5px;">
                                                <B><?php echo $lang['xfield_xname'];
                                                    ?></B>
                                            </td>
                                            <td>
                                                <B><?php echo $lang['xfield_xcat'];
                                                    ?></B>
                                            </td>
                                            <td>
                                                <B><?php echo $lang['xfield_xtype'];
                                                    ?></B>
                                            </td>
                                            <td>
                                                <B><?php echo $lang['xfield_xwt'];
                                                    ?></B>
                                            </td>
                                            <td width=10>&nbsp;
                                            </td>
                                        ...
                                        <tr>
                                            <td><a class=main onClick="javascript:Help('xfields')"
                                                   href="#"><?php echo $lang['xfield_xhelp'];
                                                ?></a></td>
                                            <td colspan="4" class="main" style="text-align: right; padding-top: 10px;">
                                                ...
                                                <select name="xfieldssubaction">
                                                    <option value="edit"><?php echo $lang['xfield_xedit'];
                                                        ?></option>
                                                    <option value="delete"><?php echo $lang['xfield_xdel'];
                                                        ?></option>
                                                    <option value="moveup"><?php echo $lang['xfield_xo'];
                                                        ?></option>
                                                    <option value="movedown"><?php echo $lang['xfield_xu'];
                                                        ?></option>
                                                </select>
                                                <input type="submit" class="btn btn-warning btn-mini"
                                                       value="&nbsp;&nbsp;<?php echo $lang['b_start'];
                                                           ?>&nbsp;&nbsp;"
                                                       onclick="document.forms['xfieldsform'].xfieldssubactionadd.value = '';">
                                                <?php
                                            }
                                                ?>
                                                <input type="submit" class="btn btn-primary btn-mini"
                                                       value="&nbsp;&nbsp;<?php echo $lang['b_create'];
                                                       ?>&nbsp;&nbsp;"
                                                       onclick="document.forms['xfieldsform'].xfieldssubactionadd.value = 'add';">
                                            </td>
                                        </tr>
                                    </table>
                                </td>
    ...
    case "list":
        ...
        foreach ($xfields as $name => $value) {
            ...
            if (!$xfieldsadd) {
                ...
                if ($row['allow_br']) $fieldvalue = $parse->decodeBBCodes($fieldvalue, false);
                else $fieldvalue = $parse->decodeBBCodes($fieldvalue, true, "yes");
            } elseif ($value[3] != "select") {
                $fieldvalue = $value[4];
            }
            $holderid = "xfield_holder_$fieldname";
            if ($value[3] == "textarea") {
                if ($bb_editor) $params = "onfocus=\"setFieldName(this.id)\" ";
        ...
        foreach ($category as $cats_explode) {
            foreach ($xfields as $name => $value) {
                ...
                if ($value[5] == 0 and $postedxfields[$value[0]] == "") {
                    if ($add_module == "yes") $stop .= $lang['xfield_xerr1'];
                    else msg("error", "error", "$lang[xfield_xerr1]<br /><a href=\"javascript:history.go(-1)\">$lang[func_msg]</a>");
                }
                if ($value[3] == "select") {
                    $options = explode("\r\n", $value[4]);
    ...
    case "templatereplacepreview":
        ...
        foreach ($xfields as $value) {
            ...
            if (preg_match("#\\[xfvalue_{$preg_safe_name} limit=['\"](.+?)['\"]\\]#i", $xfieldsoutput, $matches)) {
                ...
                if ($count AND xtm_strlen($xfield[$value[0]], $config['charset']) > $count) {
                    $xfield[$value[0]] = xtm_substr($xfield[$value[0]], 0, $count, $config['charset']);
                    if (($temp_dmax = xtm_strrpos($xfield[$value[0]], ' ', $config['charset']))) $xfield[$value[0]] = xtm_substr($xfield[$value[0]], 0, $temp_dmax, $config['charset']);
                }
                $xfieldsoutput = str_replace($matches[0], $xfield[$value[0]], $xfieldsoutput);
            } else $xfieldsoutput = preg_replace("'\\[xfvalue_{$preg_safe_name}\\]'i", $xfield[$value[0]], $xfieldsoutput);
        }
        break;
    case "categoryfilter":
        $categoryfilter = <<<HTML
...
HTML;
        ...
        break;
    default:
        if (function_exists('msg')) msg("error", $lang['xfield_error'], $lang['xfield_xerr2']);
}
?>