...
<table width="100%">
    ...
    <tr>
        <td style="padding:2px;" colspan="2"><input type="submit" class="btn btn-primary" value="&nbsp;&nbsp;{$lang['find_rstart']}&nbsp;&nbsp;"><input type="hidden" name="action" value="replace"><input type="hidden" name="user_hash" value="{$xtm_login_hash}"></td>
    </tr>
</table>
</td>
