...
HTML;
    ...
    echo <<<HTML
<input type=hidden name=user_hash value="{$xtm_login_hash}"><input type="hidden" name="action" value="do_mass_move_to_cat"><input type="hidden" name="mod" value="massactions">&nbsp;<input type="submit" value="&nbsp;&nbsp;{$lang['b_start']}&nbsp;&nbsp;" class="btn btn-primary btn-mini"></td>
    </tr>
</table>
</td>
        <td background="lib/skins/images/tl_rb.gif"><img src="lib/skins/images/tl_rb.gif" width="6" height="1" border="0"></td>
...
HTML;
    ...
    echo <<<HTML
<input type=hidden name=user_hash value="{$xtm_login_hash}"><input type="hidden" name="action" value="do_mass_edit_symbol"><input type="hidden" name="mod" value="massactions">&nbsp;<input type="submit" value="{$lang['b_start']}" class="btn btn-primary btn-mini"></td>
    </tr>
</table>
</td>
        <td background="lib/skins/images/tl_rb.gif"><img src="lib/skins/images/tl_rb.gif" width="6" height="1" border="0"></td>
...
HTML;
    ...
    echo <<<HTML
<input type=hidden name=user_hash value="{$xtm_login_hash}"><input type="hidden" name="action" value="do_mass_edit_cloud"><input type="hidden" name="mod" value="massactions">&nbsp;<input type="submit" value="{$lang['b_start']}" class="btn btn-primary btn-mini"></td>
    </tr>
</table>
</td>
        <td background="lib/skins/images/tl_rb.gif"><img src="lib/skins/images/tl_rb.gif" width="6" height="1" border="0"></td>
...
HTML;
    ...
    echo <<<HTML
<input type=hidden name=user_hash value="{$xtm_login_hash}"><input type="hidden" name="action" value="do_mass_edit_author"><input type="hidden" name="mod" value="massactions">&nbsp;<input type="submit" value="{$lang['b_start']}" class="btn btn-primary btn-mini"></td>
    </tr>
</table>
</td>
        <td background="lib/skins/images/tl_rb.gif"><img src="lib/skins/images/tl_rb.gif" width="6" height="1" border="0"></td>
