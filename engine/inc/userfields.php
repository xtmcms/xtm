...
if ($xf_inited !== true) {
    function profilesave($data)
    {
        ...
        $filehanxtm = fopen(ENGINE_DIR . '/data/xprofile.txt', "w+");
        if (!$filehanxtm) msg("error", $lang['xfield_error'], "$lang[xfield_err_1] \"" . ENGINE_DIR . "/data/xprofile.txt\", $lang[xfield_err_1]");
        ...
        fclose($filehanxtm);
        header("Location: http://" . $_SERVER['HTTP_HOST'] . $_SERVER['PHP_SELF'] . "?mod=userfields&xfieldsaction=configure");
        exit;
    }
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td style="padding:5px;" bgcolor="#FFFFFF">
                                ...
                                <table width="100%">
                                    <tr>
                                        <td width="260" style="padding:4px;"><?php echo $lang['xfield_xname'];
                                            ?></td>
                                        <td><input class=edit style="width: 200px;" type="text" name="editedxfield[0]"
                                    ...
                                    <tr>
                                        <td style="padding:4px;"><?php echo $lang['xfield_xdescr'];
                                            ?></td>
                                        <td><input class=edit style="width: 200px;" type="text" name="editedxfield[1]"
                                    ...
                                    <tr>
                                        ...
                                        <td><select name="editedxfield[3]" id="type"
                                            ...
                                            <option value="text"<?php echo ($editedxfield[3] != "text") ? " selected" : "";
                                    ...
                                    <tr id="select_options">
                                        ...
                                        <td><textarea style="width: 320px; height: 100px;"
                                                      name="editedxfield[6_select]"><?php echo ($editedxfield[3] == "select") ? $editedxfield[6] : "";
                                            ?></textarea><br><?php echo $lang['xfield_xfsel'];
                                            ?></td>
                                    </tr>
                                    <tr>
                                        <td style="padding:4px;"><?php echo $lang['xp_reg'];
                                            ?></td>
                                        <td><input type="radio"
                                                   name="editedxfield[2]" <?php echo ($editedxfield[2]) ? "checked" : "";
                                            ?> value="1"> <?php echo $lang['opt_sys_yes'];
                                            ?> <input type="radio"
                                                      name="editedxfield[2]" <?php echo (!$editedxfield[2]) ? "checked" : "";
                                                ?> value="0"> <?php echo $lang['opt_sys_no'];
                                            ?> <a href="#" class="hintanchor"
                                                  onMouseover="showhint('<?php echo $lang['xp_reg_hint'];
                                                      ?>', this, event, '220px')">[?]</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding:4px;"><?php echo $lang['xp_edit'];
                                            ?></td>
                                        <td><input type="radio"
                                                   name="editedxfield[4]" <?php echo ($editedxfield[4]) ? "checked" : "";
                                            ?> value="1"> <?php echo $lang['opt_sys_yes'];
                                            ?> <input type="radio"
                                                      name="editedxfield[4]" <?php echo (!$editedxfield[4]) ? "checked" : "";
                                                ?> value="0"> <?php echo $lang['opt_sys_no'];
                                            ?> <a href="#" class="hintanchor"
                                                  onMouseover="showhint('<?php echo $lang['xp_edit_hint'];
                                                      ?>', this, event, '220px')">[?]</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding:4px;"><?php echo $lang['xp_privat'];
                                            ?></td>
                                        <td><input type="radio"
                                                   name="editedxfield[5]" <?php echo ($editedxfield[5]) ? "checked" : "";
                                            ?> value="1"> <?php echo $lang['opt_sys_yes'];
                                            ?> <input type="radio"
                                                      name="editedxfield[5]" <?php echo (!$editedxfield[5]) ? "checked" : "";
                                                ?> value="0"> <?php echo $lang['opt_sys_no'];
                                            ?> <a href="#" class="hintanchor"
                                                  onMouseover="showhint('<?php echo $lang['xp_privat_hint'];
                                                      ?>', this, event, '220px')">[?]</a>
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <tr>
                                ...
                                <td style="padding:5px;" bgcolor="#FFFFFF">
                                    <table width="100%">
                                        <tr>
                                            <td bgcolor="#EFEFEF" height="29" style="padding-left:10px;">
                                                <div class="navigation"><?php echo $lang['xp_xlist'];
                                                    ?></div>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <td>
                                                <B><?php echo $lang['xp_regh'];
                                                    ?></B>
                                            </td>
                                            <td>
                                                <B><?php echo $lang['xp_edith'];
                                                    ?></B>
                                            </td>
                                            <td>
                                                <B><?php echo $lang['xp_privath'];
                                                    ?></B>
                                            </td>
                                            <td width=10>&nbsp;
                                            </td>
                                        ...
                                        <tr>
                                            <td><a class=main onClick="javascript:Help('xprofile')"
...
HTML;
    ...
    case "init":
        ...
        foreach ($xfields as $name => $value) {
            ...
            if (intval($value[4]) OR $member_id['user_group'] == 1 OR ($value[2] AND $xfieldsadd)) $newpostedxfields[$value[0]] = substr($postedxfields[$value[0]], 0, 10000);
            else $newpostedxfields[$value[0]] = $xfieldsdata[$value[0]];
            if ($value[3] == "select") {
                $options = explode("\r\n", $value[6]);
                if (intval($value[4]) OR $member_id['user_group'] == 1 OR ($value[2] AND $xfieldsadd)) $newpostedxfields[$value[0]] = $options[$postedxfields[$value[0]]];
                else $newpostedxfields[$value[0]] = $xfieldsdata[$value[0]];
            }
        }
