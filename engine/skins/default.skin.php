...
<table width="100%">
    <tr>
        <td bgcolor="#EFEFEF" height="40" align="center" style="padding-right:10px;"><div class="navigation"><a href="http://xtm-news.ru/" target="_blank">DataLife Engine</a><br />Copyright 2004-2012 &copy; <a href="http://xtm-news.ru" target="_blank">SoftNews Media Group</a>. All rights reserved.</div></td>
    </tr>
</table></div>		
		</td>
...
<div id="login-box">
	<div style="width:447px;height:95px;background: url(engine/skins/images/loginheader.png);"><a href="http://xtm-news.ru/" style="display:block; float:right;width:90px;height:90px;" target="_blank"></a><div class="error">{result}</div></div>
