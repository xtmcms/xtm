var CodeMirror = function () {
    function a(d, e) {
        ...
        function bc(a) {
            var b = {line:0, ch:0};
            rc(b, {line:ub.size - 1, ch:_b(ub.size - 1).text.length}, hb(a), b, b), Fb = !0
        }
        ...
        function dc(a) {
            ...
            if (zb && zb.time > e - 400 && _(zb.pos, d))return Ab = {time:e, pos:d}, C(a), cd(d);
            zb = {time:e, pos:d};
            var g = d, h;
            if (f.dragDrop && T && !f.readOnly && !_(xb.from, xb.to) && !ab(d, xb.from) && !ab(xb.to, d)) {
                ...
                var j = I(document, "mouseup", Zd(i), !0), k = I(U, "drop", Zd(i), !0);
        ...
        function ec(a) {
            ...
            var c = Md(a);
            if (!c)return;
            Ab = {time:+(new Date), pos:c}, C(a), cd(c)
        }

        function fc(a) {
            if (f.onDragEvent && f.onDragEvent($b, B(a)))return;
            a.preventDefault();
            var b = Md(a, !0), c = a.dataTransfer.files;
        ...
        function nc(a) {
            Cc && Gc();
            if (f.onKeyEvent && f.onKeyEvent($b, B(a)))return;
            var b = H(a, "keyCode"), c = H(a, "charCode");
        ...
        function sc(a, b) {
            ...
            for (var e = c.length - 1; e >= 0; e -= 1) {
                var f = c[e], g = [], h = f.start + f.added;
                ub.iter(f.start, h, function (a) {
                    g.push(a.text)
                }), d.push({start:f.start, added:f.old.length, old:g});
                var i = Yc({line:f.start + f.old.length - 1, ch:eb(g[g.length - 1], f.old[f.old.length - 1])});
                vc({line:f.start, ch:0}, {line:h - 1, ch:_b(h - 1).text.length}, f.old, i, i)
            }
            Fb = !0, b.push(d)
        }
        ...
        function vc(a, b, c, d, e) {
            ...
            var i = b.line - a.line, j = _b(a.line), k = _b(b.line);
            ...
            } else if (c.length == 1)j.replace(a.ch, null, c[0]), k.replace(null, b.ch, ""), j.append(k), ub.remove(a.line + 1, i, Mb); else {
                var l = [];
        ...
        function xc(a, b, c) {
            ...
            return zc(a, b, c, function (a) {
                return e = a, {from:d(xb.from), to:d(xb.to)}
            }), e
        }

        function yc(a, b) {
            zc(hb(a), xb.from, xb.to, function (a) {
                return b == "end" ? {from:a, to:a} : b == "start" ? {from:xb.from, to:xb.from} : {from:xb.from, to:a}
            })
        }
        ...
        function Gc() {
            ...
            if (a == Fc)return!1;
            yb = null;
            var b = 0, c = Math.min(Fc.length, a.length);
            while (b < c && Fc[b] == a[b])++b;
            return b < Fc.length ? xb.from = {line:xb.from.line, ch:xb.from.ch - (Fc.length - b)} : Db && _(xb.from, xb.to) && (xb.to = {line:xb.to.line, ch:Math.min(_b(xb.to.line).text.length, xb.to.ch + (a.length - b))}), yc(a.slice(b), "end"), a.length > 1e3 ? R.value = Fc = "" : Fc = a, !0
        }
        ...
        function Kc() {
            var a = Ad(xb.inverted ? xb.from : xb.to), b = f.lineWrapping ? Math.min(a.x, kb.offsetWidth) : a.x;
        ...
        function Lc(a, b, c, d) {
            var e = Ld(), g = Kd();
            b += g, d += g, a += e, c += e;
            var h = U.clientHeight, i = U.scrollTop, j = !1, k = !0;
            b < i ? (U.scrollTop = Math.max(0, b), j = !0) : d > i + h && (U.scrollTop = d - h, j = !0);
            var l = U.clientWidth, m = U.scrollLeft, n = f.fixedGutter ? cb.clientWidth : 0, o = a < n + e + 10;
        ...
        function Mc() {
            var a = Gd(), b = U.scrollTop - Kd(), c = Math.max(0, Math.floor(b / a)), d = Math.ceil((b + U.clientHeight) / a);
            return{from:x(ub, c), to:x(ub, d)}
        }

        function Nc(a, b) {
            function n() {
                Ub = U.clientWidth;
                var a = ob.firstChild, b = !1;
            ...
            var d = Math.max(c.from - 100, 0), e = Math.min(ub.size, c.to + 100);
            Pb < d && d - Pb < 20 && (d = Pb), Qb > e && Qb - e < 20 && (e = Math.min(ub.size, Qb));
            var g = a === !0 ? [] : Oc([
                {from:Pb, to:Qb, domStart:0}
            ], a), h = 0;
        ...
        function Pc(a, b, c) {
            if (!c.length)ob.innerHTML = ""; else {
                function d(a) {
                    var b = a.nextSibling;
                    return a.parentNode.removeChild(a), b
                }

                var e = 0, f = ob.firstChild, g;
            ...
            var l = c.shift(), f = ob.firstChild, j = a, m = document.createElement("div");
        ...
        function Qc() {
            ...
            var a = X.offsetHeight, b = U.clientHeight;
            cb.style.height = (a - b < 2 ? b : a) + "px";
            var c = [], d = Pb, e;
            ub.iter(Pb, Math.max(Qb, Pb + 1), function (a) {
                if (a.hidden)c.push("<pre></pre>"); else {
                    var b = a.gutterMarker, g = f.lineNumbers ? d + f.firstLineNumber : null;
            ...
            if (e != null) {
                var g = db.childNodes[e - Pb], h = String(ub.size).length, i = Z(g), j = "";
        ...
        function Rc() {
            var a = _(xb.from, xb.to), b = Ad(xb.from, !0), c = a ? b : Ad(xb.to, !0), d = xb.inverted ? b : c, e = Gd(), g = Y(A), h = Y(ob);
            ...
            if (a)mb.style.top = d.y + "px", mb.style.left = (f.lineWrapping ? Math.min(d.x, kb.offsetWidth) : d.x) + "px", mb.style.display = "", nb.style.display = "none"; else {
                var i = b.y == c.y, j = "", k = kb.clientWidth || kb.offsetWidth, l = kb.clientHeight || kb.offsetHeight;
                ...
                var o = Math.max(0, b.y + (xb.from.ch ? e : 0)), p = Math.min(c.y, l) - o;
                ...
                if (h.line != xb.from.line && xb.from.line < ub.size) {
                    ...
                    /^\s+$/.test(i.text) && setTimeout(Zd(function () {
                        if (i.parent && /^\s+$/.test(i.text)) {
                            var a = w(i);
                            xc("", {line:a, ch:0}, {line:a, ch:i.text.length})
                        }
                    }, 10))
                }
            }
        ...
        function Vc(a, b, c) {
            function d(b) {
                var d = a.line + b, e = b == 1 ? ub.size : -1;
                while (d != e) {
                    var g = _b(d);
                    if (!g.hidden) {
                        var h = a.ch;
            ...
            var e = _b(a.line), f = a.ch == e.text.length && a.ch != c;
            return e.hidden ? a.line >= b ? d(1) || d(-1) : d(-1) || d(1) : a
        }

        function Wc(a, b, c) {
            var d = Yc({line:a, ch:b || 0});
            (c ? Tc : Uc)(d, d)
        }
        ...
        function Yc(a) {
            ...
            if (a.line >= ub.size)return{line:ub.size - 1, ch:_b(ub.size - 1).text.length};
            var b = a.ch, c = _b(a.line).text.length;
        ...
        function Zc(a, b) {
            ...
            var c = xb.inverted ? xb.from : xb.to, d = c.line, e = c.ch, f = _b(d);
            if (b == "char")h(); else if (b == "column")h(!0); else if (b == "word") {
                var i = !1;
                for (; ;) {
                    if (a < 0 && !h())break;
                    if (gb(f.text.charAt(e)))i = !0; else if (i) {
                        a < 0 && (a = 1, h());
                        break
                    }
                    if (a > 0 && !h())break
        ...
        function bd(a, b) {
            var c = 0, d = Ad(xb.inverted ? xb.from : xb.to, !0);
        ...
        function cd(a) {
            var b = _b(a.line).text, c = a.ch, d = a.ch;
            while (c > 0 && gb(b.charAt(c - 1)))--c;
            while (d < b.length && gb(b.charAt(d)))++d;
            Tc({line:a.line, ch:c}, {line:a.line, ch:d})
        }

        function dd(a) {
            Tc({line:a, ch:0}, Yc({line:a + 1, ch:0}))
        }
        ...
        function fd(a, b) {
            b || (b = "add");
            if (b == "smart")if (!tb.indent)b = "prev"; else var c = Sd(a);
            var d = _b(a), e = d.indentation(f.tabSize), g = d.text.match(/^\s*/)[0], h;
            ...
            xc(j, {line:a, ch:0}, {line:a, ch:g.length})
        }
        ...
        function id(a, b) {
            ...
            Hb.push({from:0, to:ub.size})
        }

        function jd(a) {
            var b = f.tabSize - a % f.tabSize, c = Vb[b];
            if (c)return c;
            for (var d = '<span class="cm-tab">', e = 0; e < b; ++e)d += " ";
            return Vb[b] = {html:d + "</span>", width:b}
        }
        ...
        function nd(a, b, c) {
            ...
            return Hb.push({from:a.line, to:b.line + 1}), d
        }
        ...
        function qd(a, b, c) {
            return typeof a == "number" && (a = _b(Xc(a))), a.gutterMarker = {text:b, style:c}, Lb = !0, a
        }
        ...
        function sd(a, b) {
            var c = a, d = a;
            return typeof a == "number" ? d = _b(Xc(a)) : c = w(a), c == null ? null : b(d, c) ? (Hb.push({from:c, to:c + 1}), d) : null
        }
        ...
        function ud(a, b) {
            return sd(a, function (a, c) {
                if (a.hidden != b) {
                    ...
                    ac(a, b ? 0 : 1);
                    var e = xb.from.line, g = xb.to.line;
                    if (b && (e == c || g == c)) {
                        var h = e == c ? Vc({line:e, ch:0}, e, 0) : xb.from, i = g == c ? Vc({line:g, ch:0}, g, 0) : xb.to;
                        if (!i)return;
                        Uc(h, i)
                    }
                    return Lb = !0
        ...
        function vd(a) {
            ...
            return{line:b, hanxtm:a, text:a.text, markerText:c && c.text, markerClass:c && c.style, lineClass:a.className, bgClass:a.bgClassName}
        }
        ...
        function xd(a, b) {
            ...
            if (b <= 0)return 0;
            var c = _b(a), d = c.text, f = 0, g = 0, h = d.length, i, j = Math.min(h, Math.ceil(b / Jd()));
            for (; ;) {
                var k = e(j);
                if (!(k <= b && j < h)) {
                    i = k, h = j;
        ...
        function zd(a, b) {
            ...
            var d = document.getElementById(yd), e = d.offsetTop, g = d.offsetLeft;
            if (M && e == 0 && g == 0) {
        ...
        function Ad(a, b) {
            var c, d = Gd(), e = d * (y(ub, a.line) - (b ? Ob : 0));
            if (a.ch == 0)c = 0; else {
        ...
        function Bd(a, b) {
            ...
            b < 0 && (b = 0);
            var c = Gd(), d = Jd(), e = Ob + Math.floor(b / c), g = x(ub, e);
            if (g >= ub.size)return{line:ub.size - 1, ch:_b(ub.size - 1).text.length};
            var h = _b(g), i = h.text, j = f.lineWrapping, k = j ? e - y(ub, g) : 0;
            if (a <= 0 && k == 0)return{line:g, ch:0};
            var m = 0, n = 0, o = i.length, p, q = Math.min(o, Math.ceil((a + k * U.clientWidth * .9) / d));
            for (; ;) {
                var r = l(q);
                if (!(r <= a && q < o)) {
                    p = r, o = q;
        ...
        function Qd(a) {
            ...
            var b = xb.inverted ? xb.from : xb.to, c = _b(b.line), d = b.ch - 1, e = d >= 0 && Pd[c.text.charAt(d)] || Pd[c.text.charAt(++d)];
            if (!e)return;
            ...
            for (var k = b.line, l = g ? Math.min(k + 100, ub.size) : Math.max(-1, k - 100); k != l; k += h) {
                var c = _b(k), q = k == b.line, r = p(c, q && g ? d + 1 : 0, q && !g ? d : c.text.length);
                if (r)break
            }
            r || (r = {pos:null, match:!1});
            var m = r.match ? "CodeMirror-matchingbracket" : "CodeMirror-nonmatchingbracket", s = nd({line:b.line, ch:d}, {line:b.line, ch:d + 1}, m), t = r.pos != null && nd({line:k, ch:r.pos}, {line:k, ch:r.pos + 1}, m), u = Zd(function () {
                s.clear(), t && t.clear()
            });
        ...
        function Sd(a) {
            var b = Rd(a), c = b && _b(b - 1).stateAfter;
            return c ? c = m(tb, c) : c = n(tb), ub.iter(b, a, function (a) {
                a.highlight(tb, c, f.tabSize), a.stateAfter = m(tb, c)
            }), b < a && Hb.push({from:b, to:a}), a < ub.size && !_b(a).stateAfter && vb.push(a), c
        }
        ...
        function Ud() {
            var a = +(new Date) + f.workTime, b = vb.length;
            while (vb.length) {
                if (!_b(Pb).stateAfter)var c = Pb; else var c = vb.pop();
                if (c >= ub.size)continue;
                var d = Rd(c), e = d && _b(d - 1).stateAfter;
                e ? e = m(tb, e) : e = n(tb);
                var g = 0, h = tb.compareStates, i = !1, j = d, k = !1;
                ub.iter(j, ub.size, function (b) {
                    var d = b.stateAfter;
                    if (+(new Date) > a)return vb.push(j), Vd(f.workDelay), i && Hb.push({from:c, to:j + 1}), k = !0;
        ...
        var D = A.firstChild, R = D.firstChild, U = A.lastChild, W = U.firstChild, X = W.firstChild, cb = X.firstChild, db = cb.firstChild, kb = cb.nextSibling.firstChild, lb = kb.firstChild, mb = lb.nextSibling, nb = mb.nextSibling, ob = nb.nextSibling;
        ...
        var qb = new J, rb = new J, sb, tb, ub = new u([new t([new r("")])]), vb, wb;
        gd();
        var xb = {from:{line:0, ch:0}, to:{line:0, ch:0}, inverted:!1}, yb, zb, Ab, Bb = 0, Cb, Db = !1, Eb = !1, Fb, Gb, Hb, Ib, Jb, Kb, Lb, Mb, Nb, Ob = 0, Pb = 0, Qb = 0, Rb = 0, Sb, Tb = "", Ub, Vb = {};
        Zd(function () {
            bc(f.value || ""), Fb = !1
        })();
        var Wb = new z;
        ...
        var $b = A.CodeMirror = {getValue:cc, setValue:Zd(bc), getSelection:Bc, replaceSelection:Zd(yc), focus:function () {
            ...
            return f[a]
        }, undo:Zd(tc), redo:Zd(uc), indentLine:Zd(function (a, b) {
            typeof b != "string" && (b == null ? b = f.smartIndent ? "smart" : "prev" : b = b ? "add" : "subtract"), Zb(a) && fd(a, b)
        }), indentSelection:Zd(ed), historySize:function () {
            return{undo:Wb.done.length, redo:Wb.undone.length}
        ...
        }, markText:Zd(nd), setBookmark:od, findMarksAt:pd, setMarker:Zd(qd), clearMarker:Zd(rd), setLineClass:Zd(td), hideLine:Zd(function (a) {
            return ud(a, !0)
        ...
        }, lineInfo:vd, addWidget:function (a, b, c, d, e) {
            a = Ad(Yc(a));
            var f = a.yBot, g = a.x;
            b.style.position = "absolute", W.appendChild(b);
            if (d == "over")f = a.y; else if (d == "near") {
                var h = Math.max(U.offsetHeight, ub.height * Gd()), i = Math.max(W.clientWidth, kb.clientWidth) - Ld();
            ...
            return ub.size
        }, clipPos:Yc, getCursor:function (a) {
        ...
        }, getLineHanxtm:function (a) {
            if (Zb(a))return _b(a)
        }, setLine:Zd(function (a, b) {
            Zb(a) && xc(b, {line:a, ch:0}, {line:a, ch:_b(a).text.length})
        }), removeLine:Zd(function (a) {
            Zb(a) && xc("", {line:a, ch:0}, Yc({line:a + 1, ch:0}))
        }), replaceRange:Zd(xc), getRange:function (a, b) {
            return Ac(Yc(a), Yc(b))
        }, triggerOnKeyDown:Zd(mc), execCommand:function (a) {
            return h[a]($b)
        }, moveH:Zd($c), deleteH:Zd(_c), moveV:Zd(bd), toggleOverwrite:function () {
        ...
        md.prototype.clear = Zd(function () {
            ...
            a != Infinity && Hb.push({from:a, to:b + 1})
        ...
        var yd = "CodeMirror-temp-" + Math.floor(Math.random() * 16777215).toString(16), Dd, Ed, Fd, Hd, Id = 0, Pd = {"(":")>", ")":"(<", "[":"]>", "]":"[<", "{":"}>", "}":"{<"}, Yd = 0;
    ...
    var b = /AppleWebKit/.test(navigator.userAgent) && /Mobile\/\w+/.test(navigator.userAgent), c = b || /Mac/.test(navigator.platform), d = /Win/.test(navigator.platform), e = a.modes = {}, f = a.mimeModes = {};
    a.defineMode = function (b, c) {
        ...
        if (typeof b == "string" && f.hasOwnProperty(b))b = f[b]; else if (typeof b == "string" && /^[\w\-]+\/[\w\-]+\+xml$/.test(b))return a.resolveMode("application/xml");
        return typeof b == "string" ? {name:b} : b || {name:"null"}
    }, a.getMode = function (b, c) {
        var c = a.resolveMode(c), d = e[c.name];
    ...
    var h = a.commands = {selectAll:function (a) {
        ...
        var b = a.getCursor(!0), c = a.getCursor(!1), d = !_(b, c);
    ...
    i.basic = {Left:"goCharLeft", Right:"goCharRight", Up:"goLineUp", Down:"goLineDown", End:"goLineEnd", Home:"goLineStartSmart", PageUp:"goPageUp", PageDown:"goPageDown", Delete:"delCharRight", Backspace:"delCharLeft", Tab:"defaultTab", "Shift-Tab":"indentAuto", Enter:"newlineAndIndent", Insert:"toggleOverwrite"}, i.pcDefault = {"Ctrl-A":"selectAll", "Ctrl-D":"deleteLine", "Ctrl-Z":"undo", "Shift-Ctrl-Z":"redo", "Ctrl-Y":"redo", "Ctrl-Home":"goDocStart", "Alt-Up":"goDocStart", "Ctrl-End":"goDocEnd", "Ctrl-Down":"goDocEnd", "Ctrl-Left":"goWorxtmft", "Ctrl-Right":"goWordRight", "Alt-Left":"goLineStart", "Alt-Right":"goLineEnd", "Ctrl-Backspace":"delWorxtmft", "Ctrl-Delete":"delWordRight", "Ctrl-S":"save", "Ctrl-F":"find", "Ctrl-G":"findNext", "Shift-Ctrl-G":"findPrev", "Shift-Ctrl-F":"replace", "Shift-Ctrl-R":"replaceAll", "Ctrl-[":"indentLess", "Ctrl-]":"indentMore", fallthrough:"basic"}, i.macDefault = {"Cmd-A":"selectAll", "Cmd-D":"deleteLine", "Cmd-Z":"undo", "Shift-Cmd-Z":"redo", "Cmd-Y":"redo", "Cmd-Up":"goDocStart", "Cmd-End":"goDocEnd", "Cmd-Down":"goDocEnd", "Alt-Left":"goWorxtmft", "Alt-Right":"goWordRight", "Cmd-Left":"goLineStart", "Cmd-Right":"goLineEnd", "Alt-Backspace":"delWorxtmft", "Ctrl-Alt-Backspace":"delWordRight", "Alt-Delete":"delWordRight", "Cmd-S":"save", "Cmd-F":"find", "Cmd-G":"findNext", "Shift-Cmd-G":"findPrev", "Cmd-Alt-F":"replace", "Shift-Cmd-Alt-F":"replaceAll", "Cmd-[":"indentLess", "Cmd-]":"indentMore", fallthrough:["basic", "emacsy"]}, i["default"] = c ? i.macDefault : i.pcDefault, i.emacsy = {"Ctrl-F":"goCharRight", "Ctrl-B":"goCharLeft", "Ctrl-P":"goLineUp", "Ctrl-N":"goLineDown", "Alt-F":"goWordRight", "Alt-B":"goWorxtmft", "Ctrl-A":"goLineStart", "Ctrl-E":"goLineEnd", "Ctrl-V":"goPageUp", "Shift-Ctrl-V":"goPageDown", "Ctrl-D":"delCharRight", "Ctrl-H":"delCharLeft", "Alt-D":"delWordRight", "Alt-Backspace":"delWorxtmft", "Ctrl-K":"killLine", "Ctrl-T":"transposeChars"}, a.fromTextArea = function (b, c) {
        function d() {
            b.value = h.getValue()
        }
    ...
    }, a.copyState = m, a.startState = n, o.prototype = {eol:function () {
    ...
    }}, a.StringStream = o, p.prototype = {attach:function (a) {
        ...
        return!this.line || !this.line.parent ? null : {line:w(this.line), ch:this.from}
    }, clear:function () {
        if (this.line) {
        ...
        var d = new o(this.text, c), e = this.styles, f = 0, g = !1, h = e[0], i;
        ...
        var l = this.styles, m = this.text, n = this.marked, o = m.length;
        if (!m && b == null)i(" "); else if (!n || !n.length)for (var q = 0, r = 0; r < o; q += 2) {
            var s = l[q], t = l[q + 1], u = s.length;
            r + u > o && (s = s.slice(0, o - r)), r += u, i(s, p(t))
        } else {
            var v = 0, q = 0, w = "", t, x = 0, y = n[0].from || 0, z = [], A = 0;
    ...
    }}, u.prototype = {chunkSize:function () {
        return this.size
    }, remove:function (a, b, c) {
        this.size -= b;
            ...
            if (a <= g) {
                ...
                if (f.lines && f.lines.length > 50) {
                    while (f.lines.length > 50) {
                        var h = f.lines.splice(f.lines.length - 25, 25), i = new t(h);
        ...
        var a = this;
        do {
            var b = a.children.splice(a.children.length - 5, 5), c = new u(b);
            if (!a.parent) {
    ...
    }}, z.prototype = {addChange:function (a, b, c) {
        this.undone.length = 0;
        var d = +(new Date), e = this.done[this.done.length - 1], f = e && e[e.length - 1], g = d - this.time;
        if (this.compound && e && !this.closed)e.push({start:a, added:b, old:c}); else if (g > 400 || !f || this.closed || f.start > a + c.length || f.start + f.added < a)this.done.push([
            {start:a, added:b, old:c}
        ]), this.closed = !1; else {
            var h = Math.max(0, f.start - a), i = Math.max(0, a + c.length - (f.start + f.added));
        ...
        --this.compound || (this.closed = !0)
    }}, a.e_stop = E, a.e_preventDefault = C, a.e_stopPropagation = D, a.connect = I, J.prototype = {set:function (a, b) {
        clearTimeout(this.id), this.id = setTimeout(b, a)
    }};
    var K = a.Pass = {toString:function () {
        return"CodeMirror.Pass"
    }}, L = /gecko\/\d{7}/i.test(navigator.userAgent), M = /MSIE \d/.test(navigator.userAgent), N = /MSIE [1-8]\b/.test(navigator.userAgent), O = M && document.documentMode == 5, P = /WebKit\//.test(navigator.userAgent), Q = /Chrome\//.test(navigator.userAgent), R = /Apple Computer/.test(navigator.vendor), S = /KHTML\//.test(navigator.userAgent), T = function () {
        if (N)return!1;
        var a = document.createElement("div");
...
CodeMirror.defineMode("css", function (a) {
    ...
    function e(a, b) {
        ...
        if (c != "=")return c != "~" && c != "|" || !a.eat("=") ? c == '"' || c == "'" ? (b.tokenize = h(c), b.tokenize(a, b)) : c == "#" ? (a.eatWhile(/[\w\\\-]/), d("atom", "hash")) : c == "!" ? (a.match(/^\s*\w*/), d("keyword", "important")) : /\d/.test(c) ? (a.eatWhile(/[\w.%]/), d("number", "unit")) : /[,.+>*\/]/.test(c) ? d(null, "select-op") : /[;{}:\[\]]/.test(c) ? d(null, c) : (a.eatWhile(/[\w\\\-]/), d("variable", "variable")) : d(null, "compare");
        d(null, "compare")
    }
    ...
    return{startState:function (a) {
        ...
        if (c == "hash" && e != "rule")d = "string-2"; else if (d == "variable")if (e == "rule")d = "number"; else if (!e || e == "@media{")d = "tag";
...
}), CodeMirror.defineMIME("text/css", "css"), CodeMirror.defineMode("htmlembedded", function (a, b) {
    function g(a, b) {
    ...
    var c = b.scriptStartRegex || /^<%/i, d = b.scriptEndRegex || /^%>/i, e, f;
    return{startState:function () {
        return e = e || CodeMirror.getMode(a, b.scriptingModeSpec), f = f || CodeMirror.getMode(a, "htmlmixed"), {token:b.startOpen ? h : g, htmlState:f.startState(), scriptState:e.startState()}
    }, token:function (a, b) {
        return b.token(a, b)
    }, indent:function (a, b) {
        return a.token == g ? f.indent(a.htmlState, b) : e.indent(a.scriptState, b)
    }, copyState:function (a) {
        return{token:a.token, htmlState:CodeMirror.copyState(f, a.htmlState), scriptState:CodeMirror.copyState(e, a.scriptState)}
    }, electricChars:"/{}:"}
    ...
    var c = CodeMirror.getMode(a, {name:"xml", htmlMode:!0}), d = CodeMirror.getMode(a, "javascript"), e = CodeMirror.getMode(a, "css");
    return{startState:function () {
        var a = c.startState();
        return{token:f, localState:null, mode:"html", htmlState:a}
    }, copyState:function (a) {
        if (a.localState)var b = CodeMirror.copyState(a.token == i ? e : d, a.localState);
        return{token:a.token, localState:b, mode:a.mode, htmlState:CodeMirror.copyState(c, a.htmlState)}
    }, token:function (a, b) {
        return b.token(a, b)
    }, indent:function (a, b) {
    ...
    function l(a, b) {
        ...
        if (/\d/.test(c) || c == "-" && a.eat(/\d/))return a.match(/^\d*(?:\.\d*)?(?:[eE][+\-]?\d+)?/), k("number", "number");
        if (c == "/")return a.eat("*") ? g(a, b, n) : a.eat("/") ? (a.skipToEnd(), k("comment", "comment")) : b.reAllowed ? (h(a, "/"), a.eatWhile(/[gimy]/), k("regexp", "string-2")) : (a.eatWhile(f), k("operator", null, a.current()));
        if (c == "#")return a.skipToEnd(), k("error", "error");
        if (f.test(c))return a.eatWhile(f), k("operator", null, a.current());
        a.eatWhile(/[\w\$_]/);
        var d = a.current(), i = e.propertyIsEnumerable(d) && e[d];
        return i && b.kwAllowed ? k(i.type, i.style, d) : k("variable", "variable", d)
    }
    ...
    function x() {
        s.state.context || (s.state.localVars = w), s.state.context = {prev:s.state.context, vars:s.state.localVars}
    }
    ...
    function B(a) {
        return function (c) {
            return c == a ? u() : a == ";" ? t() : u(arguments.callee)
        }
    }

    function C(a) {
        return a == "var" ? u(z("vardef"), L, B(";"), A) : a == "keyword a" ? u(z("form"), D, C, A) : a == "keyword b" ? u(z("form"), C, A) : a == "{" ? u(z("}"), K, A) : a == ";" ? u() : a == "function" ? u(R) : a == "for" ? u(z("form"), B("("), z(")"), N, B(")"), A, C, A) : a == "variable" ? u(z("stat"), G) : a == "switch" ? u(z("form"), D, z("}", "switch"), B("{"), K, A, A) : a == "case" ? u(D, B(":")) : a == "default" ? u(B(":")) : a == "catch" ? u(z("form"), x, B("("), S, B(")"), C, A, y) : t(z("stat"), D, B(";"), A)
    }

    function D(a) {
        return o.hasOwnProperty(a) ? u(F) : a == "function" ? u(R) : a == "keyword c" ? u(E) : a == "(" ? u(z(")"), E, B(")"), A, F) : a == "operator" ? u(D) : a == "[" ? u(z("]"), J(D, "]"), A, F) : a == "{" ? u(z("}"), J(I, "}"), A, F) : u()
    }

    function E(a) {
        return a.match(/[;\}\)\],]/) ? t() : t(D)
    }

    function F(a, b) {
        if (a == "operator" && /\+\+|--/.test(b))return u(F);
        if (a == "operator" || a == ":")return u(D);
        if (a == ";")return;
        if (a == "(")return u(z(")"), J(D, ")"), A, F);
        if (a == ".")return u(H, F);
        if (a == "[")return u(z("]"), D, B("]"), A, F)
    }

    function G(a) {
        return a == ":" ? u(A, C) : t(F, B(";"), A)
    }
    ...
    function N(a) {
        return a == "var" ? u(L, P) : a == ";" ? t(P) : a == "variable" ? u(O) : t(P)
    }

    function O(a, b) {
        return b == "in" ? u(D) : u(F, P)
    }

    function P(a, b) {
        return a == ";" ? u(Q) : b == "in" ? u(D) : u(D, B(";"), Q)
    }
    ...
    function R(a, b) {
        if (a == "variable")return v(b), u(R);
        if (a == "(")return u(z(")"), x, J(S, ")"), A, C, y)
    }
    ...
    var c = a.indentUnit, d = b.json, e = function () {
        function a(a) {
            return{type:a, style:"keyword"}
        }

        var b = a("keyword a"), c = a("keyword b"), d = a("keyword c"), e = a("operator"), f = {type:"atom", style:"atom"};
        return{"if":b, "while":b, "with":b, "else":c, "do":c, "try":c, "finally":c, "return":d, "break":d, "continue":d, "new":d, "delete":d, "throw":d, "var":a("var"), "const":a("var"), let:a("var"), "function":a("function"), "catch":a("catch"), "for":a("for"), "switch":a("switch"), "case":a("case"), "default":a("default"), "in":e, "typeof":e, "instanceof":e, "true":f, "false":f, "null":f, "undefined":f, NaN:f, Infinity:f}
    }(), f = /[+\-*&%=<>!?|]/, i, j, o = {atom:!0, number:!0, variable:!0, string:!0, regexp:!0}, s = {state:null, column:null, marked:null, cc:null}, w = {name:"this", next:{name:"arguments"}};
    return A.lex = !0, {startState:function (a) {
        return{tokenize:l, reAllowed:!0, kwAllowed:!0, cc:[], lexical:new p((a || 0) - c, 0, "block", !1), localVars:b.localVars, context:b.localVars && {vars:b.localVars}, indented:0}
    }, token:function (a, b) {
        a.sol() && (b.lexical.hasOwnProperty("align") || (b.lexical.align = !1), b.indented = a.indentation());
        if (a.eatSpace())return null;
        var c = b.tokenize(a, b);
        return i == "comment" ? c : (b.reAllowed = i == "operator" || i == "keyword c" || !!i.match(/^[\[{}\(,;:]$/), b.kwAllowed = i != ".", r(b, c, i, j, a))
    }, indent:function (a, b) {
        if (a.tokenize != l)return 0;
        var d = b && b.charAt(0), e = a.lexical;
        e.type == "stat" && d == "}" && (e = e.prev);
        var f = e.type, g = d == f;
...
}), CodeMirror.defineMIME("text/javascript", "javascript"), CodeMirror.defineMIME("application/json", {name:"javascript", json:!0}), CodeMirror.defineMode("xml", function (a, b) {
    function h(a, b) {
        function c(c) {
            return b.tokenize = c, c(a, b)
        }
    ...
    function q(a, b) {
        ...
        m.context = {prev:m.context, tagName:a, indent:m.indented, startOfLine:b, noIndent:c}
    }
    ...
    var c = a.indentUnit, d = b.htmlMode ? {autoSelfClosers:{area:!0, base:!0, br:!0, col:!0, command:!0, embed:!0, frame:!0, hr:!0, img:!0, input:!0, keygen:!0, link:!0, meta:!0, param:!0, source:!0, track:!0, wbr:!0}, implicitlyClosed:{dd:!0, li:!0, optgroup:!0, option:!0, p:!0, rp:!0, rt:!0, tbody:!0, td:!0, tfoot:!0, th:!0, tr:!0}, contextGrabbers:{dd:{dd:!0, dt:!0}, dt:{dd:!0, dt:!0}, li:{li:!0}, option:{option:!0, optgroup:!0}, optgroup:{optgroup:!0}, p:{address:!0, article:!0, aside:!0, blockquote:!0, dir:!0, div:!0, dl:!0, fieldset:!0, footer:!0, form:!0, h1:!0, h2:!0, h3:!0, h4:!0, h5:!0, h6:!0, header:!0, hgroup:!0, hr:!0, menu:!0, nav:!0, ol:!0, p:!0, pre:!0, section:!0, table:!0, ul:!0}, rp:{rp:!0, rt:!0}, rt:{rp:!0, rt:!0}, tbody:{tbody:!0, tfoot:!0}, td:{td:!0, th:!0}, tfoot:{tbody:!0}, th:{td:!0, th:!0}, thead:{tbody:!0, tfoot:!0}, tr:{tr:!0}}, doNotIndent:{pre:!0}, allowUnquoted:!0, allowMissing:!1} : {autoSelfClosers:{}, implicitlyClosed:{}, contextGrabbers:{}, doNotIndent:{}, allowUnquoted:!1, allowMissing:!1}, e = b.alignCDATA, f, g, m, n;
    return{startState:function () {
        return{tokenize:h, cc:[], indented:0, startOfLine:!0, tagName:null, context:null}
    }, token:function (a, b) {
...
}), CodeMirror.defineMIME("application/xml", "xml"), CodeMirror.mimeModes.hasOwnProperty("text/html") || CodeMirror.defineMIME("text/html", {name:"xml", htmlMode:!0}), function () {
    function a(a, b) {
        var c = a.getWrapperElement(), d = c.insertBefore(document.createElement("div"), c.firstChild);
        return d.className = "CodeMirror-dialog", d.innerHTML = "<div>" + b + "</div>", d
    }

    CodeMirror.defineExtension("openDialog", function (b, c) {
        function g() {
            if (e)return;
            e = !0, d.parentNode.removeChild(d)
        }

        var d = a(this, b), e = !1, f = this, h = d.getElementsByTagName("input")[0];
        return h && (CodeMirror.connect(h, "keydown", function (a) {
            if (a.keyCode == 13 || a.keyCode == 27)CodeMirror.e_stop(a), g(), f.focus(), a.keyCode == 13 && c(h.value)
        }), h.focus(), CodeMirror.connect(h, "blur", g)), g
    }), CodeMirror.defineExtension("openConfirm", function (b, c) {
        function i() {
            if (f)return;
            f = !0, d.parentNode.removeChild(d), g.focus()
        }

        var d = a(this, b), e = d.getElementsByTagName("button"), f = !1, g = this, h = 1;
        e[0].focus();
        for (var j = 0; j < e.length; ++j) {
            var k = e[j];
            (function (a) {
                CodeMirror.connect(k, "click", function (b) {
                    CodeMirror.e_preventDefault(b), i(), a && a(g)
                })
            })(c[j]), CodeMirror.connect(k, "blur", function () {
                --h, setTimeout(function () {
                    h <= 0 && i()
                }, 200)
            }), CodeMirror.connect(k, "focus", function () {
                ++h
            })
        }
    })
    ...
    function b(b) {
        return b._searchState || (b._searchState = new a)
    }
    ...
    function e(a) {
        var b = a.match(/^\/(.*)\/$/);
        return b ? new RegExp(b[1]) : a
    }

    function g(a, d) {
        var g = b(a);
        if (g.query)return h(a, d);
        c(a, f, "Search for:", function (b) {
            a.operation(function () {
                if (!b || g.query)return;
                g.query = e(b);
                if (a.lineCount() < 2e3)for (var c = a.getSearchCursor(b); c.findNext();)g.marked.push(a.markText(c.from(), c.to(), "CodeMirror-searching"));
                g.posFrom = g.posTo = a.getCursor(), h(a, d)
            })
        })
    }
    ...
    function h(a, c) {
        a.operation(function () {
            var d = b(a), e = a.getSearchCursor(d.query, c ? d.posFrom : d.posTo);
            if (!e.find(c)) {
                e = a.getSearchCursor(d.query, c ? {line:a.lineCount() - 1} : {line:0, ch:0});
                if (!e.find(c))return
            }
            a.setSelection(e.from(), e.to()), d.posFrom = e.from(), d.posTo = e.to()
        })
    }
    ...
    function i(a) {
        a.operation(function () {
            ...
            if (!c.query)return;
            c.query = null;
            for (var d = 0; d < c.marked.length; ++d)c.marked[d].clear();
            c.marked.length = 0
        })
    }

    function m(a, b) {
        c(a, j, "Replace:", function (f) {
            if (!f)return;
            f = e(f), c(a, k, "Replace with:", function (c) {
                if (b)a.compoundChange(function () {
                    a.operation(function () {
                        for (var b = a.getSearchCursor(f); b.findNext();)if (typeof f != "string") {
                            var d = a.getRange(b.from(), b.to()).match(f);
                            b.replace(c.replace(/\$(\d)/, function (a, b) {
                                return d[b]
                            }))
                        } else b.replace(c)
                    })
                    ...
                    i(a);
                    var e = a.getSearchCursor(f, a.getCursor());

                    function g() {
                        var b = e.from(), c;
                        if (!(c = e.findNext())) {
                            e = a.getSearchCursor(f);
                            if (!(c = e.findNext()) || e.from().line == b.line && e.from().ch == b.ch)return
                        }
                        a.setSelection(e.from(), e.to()), d(a, l, "Replace?", [function () {
                            h(c)
                        }, g])
                    }

                    function h(a) {
                        e.replace(typeof f == "string" ? c : c.replace(/\$(\d)/, function (b, c) {
                            return a[c]
                        })), g()
                    }
    ...
    var f = '\u041d\u0430\u0439\u0442\u0438: <input type="text" style="width: 10em"/>', j = '\u0417\u0430\u043c\u0435\u043d\u0430: <input type="text" style="width: 10em"/>', k = '\u041d\u0430: <input type="text" style="width: 10em"/>', l = "\u041f\u0440\u043e\u0438\u0437\u0432\u0435\u0441\u0442\u0438 \u0437\u0430\u043c\u0435\u043d\u0443? <button>\u0414\u0430</button> <button>\u041d\u0435\u0442</button> <button>\u041e\u0442\u043c\u0435\u043d\u0430</button>";
    CodeMirror.commands.find = function (a) {
        i(a), g(a)
    }, CodeMirror.commands.findNext = g, CodeMirror.commands.findPrev = function (a) {
        g(a, !0)
    }, CodeMirror.commands.clearSearch = i, CodeMirror.commands.replace = m, CodeMirror.commands.replaceAll = function (a) {
        m(a, !0)
    }
}(), function () {
    function a(a, b, c, d) {
        this.atOccurrence = !1, this.cm = a, d == null && typeof b == "string" && (d = !1), c = c ? a.clipPos(c) : {line:0, ch:0}, this.pos = {from:c, to:c};
        if (typeof b != "string")this.matches = function (c, d) {
            if (c) {
                var e = a.getLine(d.line).slice(0, d.ch), f = e.match(b), g = 0;
                while (f) {
                    var h = e.indexOf(f[0]);
                    g += h, e = e.slice(h + 1);
                    var i = e.match(b);
            ...
            } else var e = a.getLine(d.line).slice(d.ch), f = e.match(b), g = f && d.ch + e.indexOf(f[0]);
            if (f)return{from:{line:d.line, ch:g}, to:{line:d.line, ch:g + f[0].length}, match:f}
        }; else {
            d && (b = b.toLowerCase());
            var e = d ? function (a) {
            ...
            f.length == 1 ? this.matches = function (c, d) {
                var f = e(a.getLine(d.line)), g = b.length, h;
                if (c ? d.ch >= g && (h = f.lastIndexOf(b, d.ch - g)) != -1 : (h = f.indexOf(b, d.ch)) != -1)return{from:{line:d.line, ch:h}, to:{line:d.line, ch:h + g}}
    ...
    a.prototype = {findNext:function () {
        ...
        function d(a) {
            var c = {line:a, ch:0};
            return b.pos = {from:c, to:c}, b.atOccurrence = !1, !1
        }

        var b = this, c = this.cm.clipPos(a ? this.pos.from : this.pos.to);
        for (; ;) {
            if (this.pos = this.matches(a, c))return this.atOccurrence = !0, this.pos.match || !0;
            if (a) {
                if (!c.line)return d(0);
                c = {line:c.line - 1, ch:this.cm.getLine(c.line - 1).length}
            } else {
                var e = this.cm.lineCount();
                if (c.line == e - 1)return d(e);
                c = {line:c.line + 1, ch:0}
            }
        }
    }, from:function () {
...
}(), CodeMirror.modeExtensions || (CodeMirror.modeExtensions = {}), CodeMirror.defineExtension("getModeExt", function () {
    var a = CodeMirror.resolveMode(this.getOption("mode")).name, b = CodeMirror.modeExtensions[a];
    if (!b)throw new Error("No extensions found for mode " + a);
    return b
}), CodeMirror.defineExtension("getModeExtAtPos", function (a) {
    var b = this.getTokenAt(a);
    return b && b.state && b.state.mode ? CodeMirror.modeExtensions[b.state.mode == "html" ? "htmlmixed" : b.state.mode] : this.getModeExt()
}), CodeMirror.defineExtension("commentRange", function (a, b, c) {
    var d = this.getModeExtAtPos(this.getCursor());
    if (a) {
        var e = this.getRange(b, c);
        this.replaceRange(d.commentStart + this.getRange(b, c) + d.commentEnd, b, c), b.line == c.line && b.ch == c.ch && this.setCursor(b.line, b.ch + d.commentStart.length)
    } else {
        var f = this.getRange(b, c), g = f.indexOf(d.commentStart), h = f.lastIndexOf(d.commentEnd);
        g > -1 && h > -1 && h > g && (f = f.substr(0, g) + f.substring(g + d.commentStart.length, h) + f.substr(h + d.commentEnd.length)), this.replaceRange(f, b, c)
    }
}), CodeMirror.defineExtension("autoIndentRange", function (a, b) {
    var c = this;
    this.operation(function () {
        for (var d = a.line; d <= b.line; d++)c.indentLine(d, "smart")
    })
}), CodeMirror.defineExtension("autoFormatRange", function (a, b) {
    var c = this.indexFromPos(a), d = this.indexFromPos(b), e = this.getModeExt().autoFormatLineBreaks(this.getValue(), c, d), f = this;
    this.operation(function () {
        f.replaceRange(e, a, b);
        var d = f.posFromIndex(c).line, g = f.posFromIndex(c + e.length).line;
        for (var h = d; h <= g; h++)f.indentLine(h, "smart")
    })
}), CodeMirror.modeExtensions.css = {commentStart:"/*", commentEnd:"*/", wordWrapChars:[";", "\\{", "\\}"], autoFormatLineBreaks:function (a) {
    return a.replace(new RegExp("(;|\\{|\\})([^\r\n])", "g"), "$1\n$2")
}}, CodeMirror.modeExtensions.javascript = {commentStart:"/*", commentEnd:"*/", wordWrapChars:[";", "\\{", "\\}"], getNonBreakableBlocks:function (a) {
    var b = [new RegExp("for\\s*?\\(([\\s\\S]*?)\\)"), new RegExp("'([\\s\\S]*?)('|$)"), new RegExp('"([\\s\\S]*?)("|$)'), new RegExp("//.*([\r\n]|$)")], c = new Array;
    for (var d = 0; d < b.length; d++) {
        var e = 0;
        while (e < a.length) {
            var f = a.substr(e).match(b[d]);
            if (f == null)break;
            c.push({start:e + f.index, end:e + f.index + f[0].length}), e += f.index + Math.max(1, f[0].length)
        }
    }
    return c.sort(function (a, b) {
        return a.start - b.start
    }), c
}, autoFormatLineBreaks:function (a) {
    var b = 0, c = new RegExp("(;|\\{|\\})([^\r\n])", "g"), d = this.getNonBreakableBlocks(a);
    if (d != null) {
        var e = "";
        for (var f = 0; f < d.length; f++)d[f].start > b && (e += a.substring(b, d[f].start).replace(c, "$1\n$2"), b = d[f].start), d[f].start <= b && d[f].end >= b && (e += a.substring(b, d[f].end), b = d[f].end);
        return b < a.length - 1 && (e += a.substr(b).replace(c, "$1\n$2")), e
    }
    return a.replace(c, "$1\n$2")
}}, CodeMirror.modeExtensions.xml = {commentStart:"<!--", commentEnd:"-->", wordWrapChars:[">"], autoFormatLineBreaks:function (a) {
    var b = a.split("\n"), c = new RegExp("(^\\s*?<|^[^<]*?)(.+)(>\\s*?$|[^>]*?$)"), d = new RegExp("<", "g"), e = new RegExp("(>)([^\r\n])", "g");
    for (var f = 0; f < b.length; f++) {
        var g = b[f].match(c);
        if (g != null && g.length > 3) {
            b[f] = g[1] + g[2].replace(d, "\n$&").replace(e, "$1\n$2") + g[3];
            continue
        }
    }
    return b.join("\n")
}}, CodeMirror.modeExtensions.htmlmixed = {commentStart:"<!--", commentEnd:"-->", wordWrapChars:[">", ";", "\\{", "\\}"], getModeInfos:function (a, b) {
    var c = new Array;
    c[0] = {pos:0, modeExt:CodeMirror.modeExtensions.xml, modeName:"xml"};
    var d = new Array;
    d[0] = {regex:new RegExp("<style[^>]*>([\\s\\S]*?)(</style[^>]*>|$)", "i"), modeExt:CodeMirror.modeExtensions.css, modeName:"css"}, d[1] = {regex:new RegExp("<script[^>]*>([\\s\\S]*?)(</script[^>]*>|$)", "i"), modeExt:CodeMirror.modeExtensions.javascript, modeName:"javascript"};
    var e = typeof b != "undefined" ? b : a.length - 1;
    for (var f = 0; f < d.length; f++) {
        var g = 0;
        while (g <= e) {
            var h = a.substr(g).match(d[f].regex);
            if (h == null)break;
            if (h.length > 1 && h[1].length > 0) {
                var i = g + h.index + h[0].indexOf(h[1]);
                c.push({pos:i, modeExt:d[f].modeExt, modeName:d[f].modeName}), c.push({pos:i + h[1].length, modeExt:c[0].modeExt, modeName:c[0].modeName}), g += h.index + h[0].length;
                continue
            }
            g += h.index + Math.max(h[0].length, 1)
        }
    }
    return c.sort(function (b, c) {
        return b.pos - c.pos
    }), c
}, autoFormatLineBreaks:function (a, b, c) {
    var d = this.getModeInfos(a), e = new RegExp("^\\s*?\n"), f = new RegExp("\n\\s*?$"), g = "";
    if (d.length > 1)for (var h = 1; h <= d.length; h++) {
        var i = d[h - 1].pos, j = h < d.length ? d[h].pos : c;
        if (i >= c)break;
        if (i < b) {
            if (j <= b)continue;
            i = b
        ...
        j > c && (j = c);
        var k = a.substring(i, j);
        d[h - 1].modeName != "xml" && (!e.test(k) && i > 0 && (k = "\n" + k), !f.test(k) && j < a.length - 1 && (k += "\n")), g += d[h - 1].modeExt.autoFormatLineBreaks(k)
    } else g = d[0].modeExt.autoFormatLineBreaks(a.substring(b, c));
    return g
}}