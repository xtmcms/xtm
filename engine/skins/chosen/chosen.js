        ...
        return f(e, b), e.prototype.setup = function () {
            ...
            for (n = 0, p = r.length; n < p; n++) {
                ...
                if (!c.disabled && !c.empty)if (c.group)a("#" + c.dom_id).css("display", "none"); else if (!this.is_multiple || !c.selected) {
                    ...
                    b ? (j.length ? (k = c.html.search(m), l = c.html.substr(0, k + j.length) + c.html.substr(k + j.length), l = l.substr(0, k) + l.substr(k)) : l = c.html, g.html(l), this.result_activate(g), c.group_array_index != null && a("#" + this.results_data[c.group_array_index].dom_id).css("display", "list-item")) : (this.result_highlight && h === this.result_highlight.attr("id") && this.result_clear_highlight(), this.result_deactivate(g))
                }
            }
