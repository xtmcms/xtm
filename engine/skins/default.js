function Help(section) {
    ...
    $("#xtmuserpopup").remove();
    $("body").append("<div id='xtmuserpopup' title='Help' style='display:none'></div>");
    ...
    $('#xtmuserpopup').dialog({
        ...
        open:function (event, ui) {
            $("#xtmuserpopup").html("<iframe width='100%' height='400' src='?mod=help&section=" + section + "' frameborder='0' marginwidth='0' marginheight='0' allowtransparency='true'></iframe>");
        },
...
function xtmalert(message, title) {

    $("#xtmpopup").remove();

    $("body").append("<div id='xtmpopup' title='" + title + "' style='display:none'><br />" + message + "</div>");
...
function xtmconfirm(message, title, callback) {
...
function xtmprompt(message, d, title, callback, allowempty) {
    ...
    b[xtm_act_lang[2]] = function () {
        if (!allowempty && $("#xtm-promt-text").val().length < 1) {
    ...
    $("body").append("<div id='xtmpopup' title='" + title + "' style='display:none'><br />" + message + "<br /><br /><input type='text' name='xtm-promt-text' id='xtm-promt-text' class='ui-widget-content ui-corner-all' style='width:97%; padding: .4em;' value=\"" + d + "\"/></div>");
...
function media_upload(area, author, news_id, wysiwyg) {
    ...
    $('#mediaupload').remove();
    $('body').append("<div id='mediaupload' title='" + xtm_act_lang[4] + "' style='display:none'></div>");
