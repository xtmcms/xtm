[pmlist]
<h2 class="heading" style="margin: 0;">Message List</h2>
[/pmlist]
[newpm]
<h2 class="heading" style="margin: 0;">Send New Message</h2>
[/newpm]
[readpm]
<h2 class="heading" style="margin: 0;">Read Message</h2>
[/readpm]
<div class="basecont">
    <div class="pm_status">
    ...
    <div style="padding-top:10px;">[inbox]Inbox[/inbox]<br/><br/>
        [outbox]Save/Outbox[/outbox]<br/><br/>
        [new_pm]Send New Message[/new_pm]
    </div>
    <br/>
    ...
    <div class="brdform">
        <div class="baseform">
                ...
                <tr>
                    ...
                    {editor}<br/>
                        ...
                        <div class="checkbox"><input type="checkbox" id="outboxcopy" name="outboxcopy" value="1"/>
                            <label for="outboxcopy">Save this message to "Save/Outbox"</label></div>
                    </td>
                </tr>
                [sec_code]
                <tr>
                    ...
                    <td>
                        <div>{sec_code}</div>
                        <div><input type="text" name="sec_code" id="sec_code" style="width:115px" class="f_input"/>
                        </div>
                    </td>
                </tr>
                [/sec_code]
            ...
            <div class="fieldsubmit">
                <button type="submit" name="add" class="fbutton"><span>Send</span></button>
                <input type="button" class="fbutton" onclick="xtmPMPreview()" title="Preview" value="Preview"/>
            </div>
        </div>
    </div>
    [/newpm]
        ...
        <div class="bcomment">
            ...
            <div class="rcol">
                <div class="combox">
                    ...
                    //]]></script>
                    <div class="infbtn">
                        <span id="pinfb" class="thide" title="Article info">User info</span>
                ...
                {text}
                    ...
                    <div class="comedit">
                        ...
                        <span class="arg">[ignore]Add to block list[/ignore]</span>
