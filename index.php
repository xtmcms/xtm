...
<!--
var xtm_root       = '{$config['http_home_url']}';
var xtm_admin      = '{$config['admin_path']}';
var xtm_login_hash = '{$xtm_login_hash}';
var xtm_group      = {$member_id['user_group']};
var xtm_skin       = '{$config['skin']}';
var xtm_wysiwyg    = '{$config['allow_comments_wysiwyg']}';
var quick_wysiwyg  = '{$config['allow_quick_wysiwyg']}';
var xtm_act_lang   = ["{$lang['p_yes']}", "{$lang['p_no']}", "{$lang['p_enter']}", "{$lang['p_cancel']}", "{$lang['p_save']}"];
...
var xtm_info       = '{$lang['p_info']}';
var xtm_confirm    = '{$lang['p_confirm']}';
var xtm_prompt     = '{$lang['p_prompt']}';
var xtm_req_field  = '{$lang['comm_req_f']}';
var xtm_del_agree  = '{$lang['news_delcom']}';
var xtm_complaint  = '{$lang['add_to_complaint']}';
var xtm_big_text   = '{$lang['big_text']}';
var xtm_orfo_title = '{$lang['orfo_title']}';
var xtm_p_send     = '{$lang['p_send']}';
var xtm_p_send_ok  = '{$lang['p_send_ok']}';
var xtm_save_ok    = '{$lang['n_save_ok']}';
var xtm_del_news   = '{$lang['news_delnews']}';\n
HTML;
if ($user_group[$member_id['user_group']]['allow_all_edit']) {
    $ajax .= <<<HTML
var xtm_notice     = '{$lang['btn_notice']}';
var xtm_p_text     = '{$lang['p_text']}';
var xtm_del_msg    = '{$lang['p_message']}';
var allow_xtm_delete_news   = true;\n
HTML;
    } else {
    $ajax .= <<<HTML
var allow_xtm_delete_news   = false;\n
HTML;
    } 
if ($config['fast_search'] AND $user_group[$member_id['user_group']]['allow_search']) {
    $ajax .= <<<HTML
var xtm_search_delay   = false;
var xtm_search_value   = '';
$(function(){
	FastSearch();
});
...
if (strpos ($tpl -> result['content'], "hs.expand") !== false or strpos ($tpl -> copy_template, "hs.expand") !== false) {
    ...
    if ($config['thumb_gallery'] AND ($xtm_module == "showfull" OR $xtm_module == "static")) {
        $gallery = "
	hs.align = 'center';
    ...
    case 1 : $type = "hs.wrapperClassName = 'wide-border';";
        break;
    case 2 : $type = "hs.wrapperClassName = 'borderless';";
        break;
    case 3 : $type = "hs.wrapperClassName = 'less';\nhs.outlineType = null;";
        break;
    default : $type = "hs.outlineType = 'rounded-white';";
        break;
    } 
    $ajax .= <<<HTML
<script type="text/javascript">  
...
$tpl -> set ('{content}', "<div id='xtm-content'>" . $tpl -> result['content'] . "</div>");
$tpl -> compile ('main');
