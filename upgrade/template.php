...
<div id="login-box">
	...
	<div style="width:283px;height:82px;float:left;background: url({$theme}/skins/images/loginbox7.png);"><div class="info">To upgrade your script, you need to enter administrator username and password</div></div>
...
if ($_POST['action'] == "dologin") {
    ...
    if (version_compare($version_id, '4.2', ">")) $pass = md5($login_password);
    else $pass = $login_password;
    if (!defined('USERPREFIX')) {
        define('USERPREFIX', PREFIX);
    } 
    ...
    if ($db -> num_rows() > 0) {
        ...
        $is_logged = true;
    } else $result = "<font color=red>Please enter login details!</font>";
    $db -> free();
} 
if (!$is_logged) {
...
<table width="100%">
    ...
    <tr>
        <td style="padding:2px;"><input class=buttons type=submit value=" Start Upgrade >> "></td>
    </tr>
</table>
</td>
        <td background="{$theme}/skins/images/tl_rb.gif"><img src="{$theme}/skins/images/tl_rb.gif" width="6" height="1" border="0"></td>
