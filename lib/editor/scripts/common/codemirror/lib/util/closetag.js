...
(function () {
    ...
    /**
     * Call during key processing to close tags.  Hanxtms the key event if the tag is closed, otherwise throws CodeMirror.Pass.
    ...
    CodeMirror.defineExtension("closeTag", function (cm, ch, indent) {
        ...
        if (mode == 'text/html') {
            ...
            if (ch == '>') {
                ...
                // Undo the '>' insert and allow cm to hanxtm the key instead.
        ...
        throw CodeMirror.Pass; // Bubble if not hanxtmd
    });
