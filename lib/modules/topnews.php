...
$tpl->result['topnews'] = xtm_cache("topnews", $config['skin'], true);
if ($tpl->result['topnews'] === false) {
    ...
    while ($row = $db->get_row()) {
        ...
        if (xtm_strlen($row['title'], $config['charset']) > 55) $title = xtm_substr($row['title'], 0, 55, $config['charset']) . " ...";
    ...
    $tpl->clear();
    $db->free();
    $tpl->result['topnews'] = str_replace("{", "&#123;", $tpl->result['topnews']);
