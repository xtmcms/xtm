 ...
 * -------- -------- -------- -------- -------- -------- -------- --------
 * SWFUpload is (c) 2006 Lars Huring, Olov Nilzйn and Mammon Media and is released under the MIT License:
...
// Private: callFlash hanxtms function calls made to the Flash element.
...
/* Hanxtm errors that occur when an attempt to queue a file fails. */
