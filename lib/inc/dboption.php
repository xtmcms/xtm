...
<table width="100%">
    ...
    <br /><center><input type="submit" id="rest" class="btn btn-primary" value="{$lang['db_action']}" /></center></td>
        <td>    <table width="100%" border="0" cellspacing="1" cellpadding="0">
          <tr>
            <td width="5%"><img src="lib/skins/images/db_optimize.gif" alt="" hspace="3" /></td>
          ...
          <tr>
            <td width="5%"><img src="lib/skins/images/db_repair.gif" alt="" hspace="3" /></td>
            <td width="5%" nowrap="nowrap"><div align="left">
...
echo <<<HTML
    ...
    function save(){
		...
		$("#xtmpopup").remove();
		$("body").append("<div id='xtmpopup' title='{$lang['db_back']}' style='display:none'></div>");
		...
		$('#xtmpopup').dialog({
			...
			open: function(event, ui) { 
				$("#xtmpopup").html("<iframe width='99%' height='220' src='{$PHP_SELF}?mod=dumper&action=backup&comp_method=" + $("#comp_method").val() + "&rndval=" + rndval + "' frameborder='0' marginwidth='0' marginheight='0' scrolling='no'></iframe>");
			},
...
echo <<<HTML
    ...
    function dbload(){
		...
		$("#xtmpopup").remove();
		$("body").append("<div id='xtmpopup' title='{$lang['db_load']}' style='display:none'></div>");
		...
		$('#xtmpopup').dialog({
			...
			open: function(event, ui) { 
				$("#xtmpopup").html("<iframe width='99%' height='220' src='{$PHP_SELF}?mod=dumper&action=restore&file=" + $("#file").val() + "&rndval=" + rndval + "' frameborder='0' marginwidth='0' marginheight='0' scrolling='no'></iframe>");
			},
			beforeClose: function(event, ui) { 
				$("#xtmpopup").html("");
			},
