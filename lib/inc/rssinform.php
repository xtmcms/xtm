...
HTML;
   ...
   <tr>
    ...
    <td class=\"list\" style=\"padding:2px;\"><img src=\"lib/skins/images/" . $status . "\" title=\"" . $lang['led_active'] . "\" border=\"0\" align=\"absmiddle\"></td>
...
menu[0]='<a onClick="document.location=\'?mod=rssinform&user_hash={$xtm_login_hash}&action=' + led_action + '&id=' + m_id + '\'; return(false)" href="#">' + lang_action + '</a>';
menu[1]='<a onClick="document.location=\'?mod=rssinform&user_hash={$xtm_login_hash}&action=edit&id=' + m_id + '\'; return(false)" href="#">{$lang['group_sel1']}</a>';
menu[2]='<a onClick="javascript:confirmdelete(' + m_id + '); return(false)" href="#">{$lang['cat_del']}</a>';

return menu;
}
function confirmdelete(id){
	    xtmconfirm( '{$lang['rssinform_del']}', '{$lang['p_confirm']}', function () {
			document.location="?mod=rssinform&user_hash={$xtm_login_hash}&action=delete&id="+id;
		} );
}
//-->
</script>
