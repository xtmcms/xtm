...
showRow($lang['opt_sys_tuxtm'], $lang['opt_sys_tuxtmd'], makeDropDown(array("1" => $lang['opt_sys_yes'], "0" => $lang['opt_sys_no']), "save_con[tube_xtm]", "{$video_config['tube_xtm']}"));
echo <<<HTML
</table>
</td>
...
if (!is_writable(ENGINE_DIR . '/data/videoconfig.php')) {
    $lang['stat_system'] = str_replace("{file}", "lib/data/videoconfig.php", $lang['stat_system']);
...
echo <<<HTML
    ...
    <input type="hidden" name="user_hash" value="$xtm_login_hash" /><input type="submit" class="btn btn-success" value="&nbsp;&nbsp;{$lang['user_save']}&nbsp;&nbsp;">{$fail}</td>
    </tr>
</table>
</td>
        <td background="lib/skins/images/tl_rb.gif"><img src="lib/skins/images/tl_rb.gif" width="6" height="1" border="0"></td>
