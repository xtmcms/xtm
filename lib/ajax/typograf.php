...
if ($config['http_home_url'] == "") {
    $config['http_home_url'] = explode("lib/ajax/typograf.php", $_SERVER['PHP_SELF']);
...
if ($config['charset'] == "windows-1251") $typo = new typographus();
else $typo = new typographus($config['charset']);
