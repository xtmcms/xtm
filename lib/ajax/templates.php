...
if ($config['http_home_url'] == "") {
    $config['http_home_url'] = explode("lib/ajax/templates.php", $_SERVER['PHP_SELF']);
...
if ($_POST['action'] == "create") {
    ...
    if (file_exists($root . $template . "/" . $file . ".tpl")) {
        ...
        if (count($files) > 2) {
            ...
            foreach ($files as $file) {
                if (file_exists($root . $_POST['dir'] . $file) && $file != '.' && $file != '..' && !is_dir($root . $_POST['dir'] . $file)) {
                    ...
                    if (in_array($ext, $allowed_extensions)) echo "<li class=\"file ext_$ext\"><a href=\"#\" rel=\"" . htmlentities($_POST['dir'] . $file) . "\">" . htmlentities($file) . "</a></li>";
                }
            }
            echo "</ul>";
        }
